...
INSERT INTO `notes_tech` VALUES (1,'#crontab do not forget to add ; after all command in crontab','2014-12-15 13:51:54',NULL,'not mentioned',NULL,NULL),(2,'#git hooks in git is used for scripting about the local repo','2014-12-15 13:51:54',NULL,'not mentioned',NULL,NULL),(3,'#git #central #important files:HEAD index objects refs','2014-12-15 13:51:54',NULL,'not mentioned',NULL,NULL),(4,'#git #refs stocke les pointeurs vers les objets','2014-12-15 13:51:54',NULL,'not mentioned',NULL,NULL),(5,'#git #head pointe sur le branche qui est en cours','2014-12-15 13:51:54',NULL,'not mentioned',NULL,NULL),(8,'#if [ -z \"$1\" ]',NULL,'true if $1 is null','not mentioned',NULL,NULL),(9,'\nthis is a tes of \nhow to do it \n',NULL,NULL,'not mentioned',NULL,NULL),(10,'#if [ -n \"$1\" ]',NULL,'this is true if $1 is NOT null','not mentioned',NULL,NULL),(11,'#mysql #for a in $(mysql_out_w/only_one_col) ; do ..... ; done',NULL,'this is how to #scan a result of mysql_select\n  ex:\n    for valXX in $(msql \"select note from notes;\")\n    do\n      echo $valXX\n    done\n','not mentioned',NULL,NULL),(12,'#script #bash #policy #var_name','2014-12-16 22:36:01','\nthose are some policy for variable name in #bash\n  error_var have to start with e_xxx\n','not mentioned',NULL,NULL),(13,'#script #bash #policy #body_of_script','2014-12-16 22:38:49','\n\nshabang\nsome description of the script\nvariables which will be used in the body of the script\ntreat the error which can be caught by the script like error in argument\n....\nbody\n....\nexit X\n','not mentioned',NULL,NULL),(14,'#git #reset #commit but _without_ changing the modification in file','2014-12-16 22:54:45',NULL,'git reset HEAD^',NULL,NULL),(15,'#git #reset #commit WITH cancelling the modification in file','2014-12-16 22:55:13',NULL,'git reset --hard HEAD^',NULL,NULL),(16,'#git #cancel #modification #ifk like #stash to go back in the modif of a file which has been commited','2014-12-16 22:57:31',NULL,'git checkout file00',NULL,NULL),(17,'#git #cancel #add in tracking','2014-12-16 23:08:37',NULL,'git reset HEAD -- file00',NULL,NULL),(19,'#git #revert','2014-12-16 23:13:13','if u made a push to the server\n  it is not possible to cancel definetely that push\n  u have to make a new push which revert the previous push','git revert 45444cz',NULL,NULL),(20,'#git #branch #create','2014-12-16 23:17:08',NULL,'git branch new_branch00',NULL,NULL),(21,'#git #branch #utility','2014-12-16 23:21:45','branch: il y a des modification que vous voulez faire mais vous n_etes pas sure des modification...... 1-stoppez et commitez par la ou vous etes sures que le code marche.... 2-creez une branche (@this__id_n_t=20)....3-passez dans une autre branche grace a git checkout branch00\n','not mentioned',NULL,NULL),(22,'#git #branch #fusion #merge','2014-12-16 23:23:34','pour fusionner une branche avec la branche master..... va dans la branch master d_abord(__git checkout master__)... faite la fusion(__git merge branch00__)','git merge branch00',NULL,NULL),(23,'#git #branch #delete ','2014-12-16 23:29:08','\nu did a fusion to branch00 to branch_master\nu want to delete branch00(__git branch -d branch00__)','git branch -d branch00',NULL,NULL),(24,'#git #branch #check ','2014-12-16 23:29:47','\nto see what are the branch which are in ur repo','git branch',NULL,NULL),(25,'#git #branch #delete without merging to master ','2014-12-16 23:31:17',NULL,'git branch -D branch00',NULL,NULL),(26,'#git #stash ','2014-12-17 00:11:55','u wanted to change to another branch but u made a modif in the current_br which is NOT commited, u don_t want to commit bcz it is a small changement........ u have to stash........then check the stash list(__git stash list__)...... to go back in the previ modif (__git stash apply stash@{5}__) that is for instance','git stash',NULL,NULL),(27,'#git #stash ','2014-12-17 00:13:25','to remove some stash which is being saved.... note that a stash is a saving which is not commited','git stash drop stash@{2}',NULL,NULL),(28,'#mysql #rename_table','2014-12-19 10:09:39','the title explains everything','rename table db00.table00 to db00.newName',NULL,NULL),(29,'#mysql #rename_user','2014-12-19 10:19:23','the title explains everything','rename user \"user00\"@\"host00\" to \"user01\"@\"host01\"',NULL,NULL),(30,'#mysql #change_pass','2014-12-19 10:21:46','the user00 must be logged into mysql;....the title explains everything','set password for \"user00\"@\"host00\" = password(\"your new pass\")',NULL,NULL),(31,'#sed #intro','2014-12-19 13:30:04','sed fonctionne en mode line par line',NULL,NULL,NULL),(32,'#sed #intro','2014-12-19 13:30:47','sed fonctionne en mode line par line\ncela a des bonnes et des mauvaises consequences',NULL,NULL,NULL),(33,'#sed #intro','2014-12-19 13:33:56','sed s\'utilise de deux facons\n  classique : on exe une cmd_sed sur un fichier puis on recupere la sortie sur une autre fichier \n  directe : on exe une cmd_sed sur un fichier puis le resultat s\'applique sur le fichier passee en entree',NULL,NULL,NULL),(34,'#sed #intro','2014-12-19 13:37:11','sed peut recevoir un script:\n  il y a 2facons de passer un scrip a sed:\n    sed -e __ici_le_script_uniligne__\n    sed -f __script_file__',NULL,NULL,NULL),(35,'#sed #important #basis',NULL,'2014-12-19 17:04:40','','\nsed -e __script_uniline__\n  ex: sed -e \'4d; 7d \' test.txt                 \n    -e : for the fact that the script \'4d; 7d \' will be performed in file_test.txt\n    -d : to delete\n      so \'4d; 7d \' meant to delete the line 4 AND 7    \n\n  ex : sed -e \'4,7 d\' test.txt\n  	to delete the line from 4 TILL 7\n\n',NULL),(36,'#sed #regex #intro','2014-12-19 17:45:24',NULL,NULL,'\nsed \'/^# / d\' test.txt',NULL),(37,'#mysql #cluster #introduction #nodes',NULL,'MySQL Clusters are built from three different types of node.\n  cluster = sum(3nodes)\n  3nodes:\n    management node\n    storage node\n    api node\n      used to extract data from db\n      most common is __mysqld__\n',NULL,NULL,NULL),(38,'#mysql #cluster #install',NULL,'\nu have to dl and install 2files\n  MySQL-Cluster-gpl-server-7.a.b-c.rhel5.x86_64.rpm\n  	this is about the server of the cluster\n  MySQL-client-community-5.a.b-c.rhel5.x86_64.rpm   	this is about the client of the cluster  \n\nafter installing these rpms, a file is created:\n  /etc/my.cnf\n\n',NULL,NULL,NULL),(39,'#mysql #status check',NULL,'\n$ service mysql status\nOR\n$ /etc/init.d mysql status\nOR\n$ telnet host00 3306\n  this is check if the server is up\n    and listening for connections on the port\n',NULL,NULL,NULL),(40,'#mysql #log check',NULL,'\nthe file of log is in:\n  /var/log/mysql/mysql.log\n    that is defined on the confFile in #general-log-file',NULL,NULL,NULL),(41,'#sec #iptables #intro','2014-12-20 09:54:56','u really need iptables to filter traffic which are permitted in ur serv\n  without ipt all traffics are almost allowed which is not good ',NULL,NULL,NULL),(42,'#sec #iptables #intro #firewall','2014-12-20 09:58:30','firewall do the analyse all packets.. do they respect the rules',NULL,NULL,NULL),(43,'#sec #iptables #intro #firewall','2014-12-20 10:02:23','criteria of filter are many: ports, protocols, addrIP, and more\n\niptables is very strict. then, if u want to activate iptables, u have to block everything, and right after, open what u want little by little',NULL,NULL,NULL),(44,'#sec #log #auth #sys','2014-12-20 10:41:41','to see who was logged into ur sys','/var/log/auth.log',NULL,NULL),(45,'#sec #log #stuff #sys','2014-12-20 10:47:34','stuff of log... errors, bugs, informations, .....','/var/log/message\n/var/log/syslog',NULL,NULL),(46,'#sec #log #fail2ban','2014-12-20 10:48:37','log of fail2ban... ','/var/log/fail2ban',NULL,NULL),(47,'#sec #log #snort','2014-12-20 10:49:21','log of snort... ','/var/log/snort/alert',NULL,NULL),(48,'#sec #log #rkhunter','2014-12-20 10:52:21','log of rkhunter... ','/var/log/rkhunter',NULL,NULL),(49,'#sec #rkhunter #intro','2014-12-20 11:02:08','if someone hacked ur sys, maybe he installed a backdoor in ur sys then he can rehack ur sys, and a rootkit to hide the hack\n\nrkhunter can detect rootkits on the server ',NULL,NULL,NULL),(50,'#sec #conf #rkhunter','2014-12-20 11:03:31','configuration_file of rkhunter','/etc/default/rkhunter',NULL,NULL),(51,'#sec #intro','2014-12-20 11:08:07','firewall had to block some connections, but the connections which are opened had to be controlled too,....\n  then we have ids (intrusion detection sys) and ips (intrustion prevention sys)\n    they are types of software which will detect all attempt of intrusion',NULL,NULL,NULL),(52,'#sec #intro','2014-12-20 11:11:32','those are the steps to do a classic intrusion:\n  scan port\n  simple attack\n  intrusion\n  how to log in the server on the purpose',NULL,NULL,NULL),(53,'#sec #intro #portsentry','2014-12-20 11:13:40','\nto block|manage who can scan ur port',NULL,NULL,NULL),(54,'#sec #conf_file #portsentry','2014-12-20 11:14:53','conf file of #portsentry','/usr/local/psionic/portsentry/portsentry.conf',NULL,NULL),(55,'#sec #conf_file #portsentry','2014-12-20 11:15:19','conf file of #portsentry','/etc/portsentry/portsentry.conf',NULL,NULL),(57,'#sec #fail2ban #intro','2014-12-20 11:27:25','\nit is based on blocking ip which tried to log into some services and which it was failed\n  it will block the ip with iptables',NULL,NULL,NULL),(58,'#sec #fail2ban #conf','2014-12-20 11:28:17',NULL,'/etc/fail2ban/jail.conf',NULL,NULL),(59,'#sec #snort #intro','2014-12-20 11:47:05','it is powerful and analyse the traffic in live, then ur sys can slow down with this\nhttp://www.trustonme.net/didactels/187.html\nhttp://doc.ubuntu-fr.org/snort\n    \n when bug appears, check /var/log/syslog\n',NULL,NULL,NULL),(60,'#sec #log #logwatch #conf_file',NULL,NULL,'/usr/share/logwatch/default.conf/logwatch.conf',NULL,NULL),(61,'#sys #conf_file #ssh',NULL,NULL,'/etc/ssh/sshd_config',NULL,NULL),(62,'#sys #conf_file #apache2',NULL,NULL,'/etc/apache2/apache2.conf',NULL,NULL),(63,'#nmap','2014-12-20 12:15:23','to scan port on a server and to make it verbose','nmap -v ip00',NULL,NULL),(64,'#nessus #intro #sec','2014-12-20 12:32:05','to scan vulnerabilities in ur sys',NULL,NULL,NULL),(65,'#osi #memo #aide_memo',NULL,'all people seems to need data processing\nOR\nplease, do not throw sausage pizza away',NULL,NULL,NULL),(66,'#mysql #query #ifnull',NULL,'this will select col00 and col01, but if col01 is null then it will be replaced by \'newVal\'','select col00, IFNULL(col01,\'newVal\')',NULL,NULL),(67,'#postfix #conf_file',NULL,NULL,'/etc/postfix/main.cf',NULL,NULL),(68,'#postfix #package_to_install',NULL,NULL,'postfix postfix-mysql libasl2-2 libasl2-modules sasl2-bin libpam-mysql procmail',NULL,NULL),(69,'#cisco #basis #intro #info #default','2014-12-20 15:24:52','by default, all pc connected to sw are in vlan1. u can check it by: sw#show vlan',NULL,NULL,NULL),(70,'#cisco #create_vlan','2014-12-20 15:26:15','sw_conf#vlan 15\nxxxxxx#name vlanName\n',NULL,NULL,NULL),(71,'#bash #preserve_space #space','2014-12-20 15:49:40','\njust put ur string inside \"\"\nor inside \'\'\n  ex: echo \' this preserve space \'\n  ex: echo this will    not preserve     the space \n',NULL,NULL,NULL),(72,'#bash #printf #basis','2014-12-20 15:51:18','\nprintf \'%s = %d\n\' lines: $line\nout__\n  lines: 245\n',NULL,NULL,NULL),(73,'#bash #echo #newline_no','2014-12-20 15:53:57','echo -n \'this need \n to do a newline\'',NULL,NULL,NULL),(74,'#bash #echo #character_special','2014-12-20 15:55:57','echo -e \'u can write here sth like \n to make a newline......do not forget the -e with echo\'',NULL,NULL,NULL),(75,'#linux #ls',NULL,'to write the result only one file per line ','ls -1',NULL,NULL),(76,'#linux #basic #output',NULL,'to write normal_out of a cmd to file01 and the error_out of a cmd to file02','cmd00 1>fileForNormal 2>fileForError',NULL,NULL),(77,'#linux #basic #output #same_file',NULL,'to write normal_out and error of a cmd to file01 ','cmd00 &> fileForNormAndErr',NULL,NULL),(78,'#linux #tail',NULL,NULL,NULL,'\nthis is to print from the bottom of the file00\n  ex: tail file00\n    will print the 10last lines of file00\n  ex: tail -n 25 \n    will print the 25last lines of file00',NULL),(79,'#git #ignore_file','2014-12-20 18:19:34','\nadd the files in .gitignore',NULL,NULL,NULL),(80,'#git #list #tag',NULL,'the order of the result do not tell as well the ?historic of the tag','git tag',NULL,NULL),(81,'#git #list #tag #specification',NULL,'to list all v1.4.1 ... v1.4.5 ... v1.4.10000','git tag -l \'v1.4.*\'',NULL,NULL),(82,'#git #tag #types','2014-12-20 21:25:27','\n2types of git_tag:\n  light:\n    almost like branch, doesn_t change\n  noted\n    stored as an object, stored in db of git\n    could checked and signed by gnu_guard\n',NULL,NULL,NULL),(83,'#git #tag #create','2014-12-20 21:32:28',NULL,NULL,'git tag -a v1.0.2 -m \'this is the comment of the tag\' \n	\n	-a	:	to create the tag\n	-m	:	to set a comment for the tag\n\n',NULL),(84,'#git #tag #show','2014-12-20 21:36:06',NULL,'git show v1.5',NULL,NULL),(85,'#git #tagging_after_commit #baliser_apres_coup','2014-12-20 21:59:57',NULL,NULL,'git tag -a v1.2 9fec56',NULL),(86,'#git #push #all_tag #tag','2014-12-20 22:02:09',NULL,NULL,'git push origin --tags\n  that is to push all tags into remote server',NULL),(87,'#git #install on #windows','2014-12-20 22:30:59','\nu have to install msysgit\n  http://code.google.com/p/msysgit',NULL,NULL,NULL),(88,'#pg #basic #intro','2014-12-21 03:25:01','\nto create a new db\n  in ur sys, u have to be the user postgres\n  $ createdb db00\nnow it is created\nto connect to it, u have to be the user postgres to do this\n  $ psql db00\n',NULL,NULL,NULL),(89,'#linux #read #end_of_file #eof','2014-12-21 03:50:24',NULL,NULL,'\nread << eof\n  u will type sth till u type eof\n',NULL),(90,'#bash #case #basic','2014-12-21 05:16:00','\n#decl_var\n# all variables which u will use in ur script should be declared before the body of the function \nlocal choice ;\nlocal answer=\' ;\nlocal question=\'do u want to play a game ? [y/n]\'\nread -p \"$question\" answer\ncase \"$answer\" in\n	[yY] ) choice=\'y\' ;;\n	[nN] ) choice=\'n\' ;;\n	*	 ) choice=\"$answer\"\n		# here if the answer is different than y/n\nesac\n\n\n',NULL,NULL,NULL),(91,'#bash #arithmetic #operation','2014-12-21 06:09:22',NULL,NULL,'\n# declaration of variable\ndeclare -i var00\nvar00=$((5+9))\n',NULL),(92,'#bash #give_value_if_null','2014-12-21 06:32:01',NULL,NULL,'\n${var00:=\'default_val\'}',NULL),(93,'#bash #give_value_if_null','2014-12-21 06:48:47',NULL,NULL,'\n${var00:=\'default_val\'}\n${var00:=\"$(pwd)\"}\n',NULL),(94,'#mysql #offset #limit #query','2014-12-21 06:53:30',NULL,NULL,'\nselect * from table00 limit 5 offset 10\n  the query will start from the result number_10\n  and will show 5 rows only',NULL),(96,'#bash #declare_var_type #type','2014-12-21 07:03:08',NULL,NULL,'\nto declare an integer \n  then u can compare the variable using -ge or -lt or .......\n    $ declare -i varInt\n',NULL),(97,'#mysql #dummy #safe-update #update','2015-01-08 10:14:08',NULL,NULL,'edit:/etc/mysql/my.cnf\n  [mysql]\n  safe-updates\n',NULL),(98,'#mysql #date #day','2015-01-08 10:47:15',NULL,NULL,'to get the day, and some info of today\n  select day(now());\n    val: 1-31\n  dayofweek()\n    val: 1 = sunday\n         ...\n         7 = saturday\n  dayname()\n    val: Thursday, Monday, ......\n  dayofyear\n    val: 1 - 366\n',NULL),(99,'#mysql #date #str_to_date','2015-01-08 11:05:50',NULL,NULL,'\nselect str_to_date(\'2015-11-28\', \'%Y-%m-%d\');\n  %Y  year\n    YYYY\n  %m  month\n    mm\n  %d  day\n    dd\n  %y  year\n    yy\n  %h  hour\n    hh\n  %i  mn\n    ii\n  %s  sec\n    ss\n',NULL),(100,'#mysql #save_all_db_in_server #server #save','2015-01-08 11:10:26',NULL,NULL,'\n$ mysqldump --user=root --password --all-databases > dump.sql\n',NULL),(101,'#mysql #save_table_into_file00.sql #table #save','2015-01-08 11:12:27',NULL,NULL,'\n$ mysqldump --user=root --password db00 table00 > table00.sql\n',NULL),(102,'#mysql #select #save #outfile',NULL,NULL,NULL,'select * from table00 into outfile \'/path/file00\'',NULL),(103,'\n#lvm #intro ',NULL,'3 basic terms:\n  physical volume \n    any block device. hdd or software_RAID_volume\n  volume group\n    collection of physical volume\n    physical volume can be added or removed from volume_group\n  logical volume\n    volume_group doesn_t have OS on it, then it needs logical_volume\n    used to mount, create file sys\n',NULL,NULL,NULL),(104,'#linux #grub #version #check',NULL,NULL,NULL,'grub-install --version',NULL),(105,'#linux #grub #change_bg #background #bg',NULL,'edit:/etc/default/grub\n  GRUB_BACKGROUND=\"/path/img00.png\"\n  sudo update-grub\n\nthat worked on grub_1.99-26',NULL,NULL,NULL),(106,'#mysql #change_pass #pwd #password',NULL,'set password=password(\'pass00\')',NULL,NULL,NULL),(107,'#linux #mmt #reinit_kali #kali #os',NULL,NULL,NULL,'those folders should be set when I just installed a new linuxOS\n  /repos\n  /opt\n',NULL),(108,'#irc #log_in',NULL,NULL,NULL,'/msg nickserv identify pseudo00 pass00',NULL),(109,'#mysql #order_by',NULL,NULL,NULL,'SELECT col01, col02, col03, col04 FROM driver_log ORDER BY 3',NULL),(110,'#linux #firefox #ff #flash #install',NULL,NULL,'\n  ø dl: http://get.adobe.com/flashplayer/\n  ø extract the .tar.gz \n  ø cp libflashplayer.so /usr/lib/mozilla/plugins/\n',NULL,NULL),(111,'#linux #filesystem #purpose_of_folder #root_folder',NULL,'\n/dev:   raha hiAcceder peripherique: partitions, disk, carte son, ports SCSI, ...\n    /etc:   ato ny daholo ny fichiers de configuration des logiciels\n    /media: fimontena peripherique amovible(ho an\'ny OS sasany)\n     /usr:   fisian\'ny fichier hoPartagena en reseau, na natao en lecture seule\n    /opt:   misy ny apps complementaire, izan hoe tsy anle distro installee\n    /var:   ao no misy ny fichiers temporaires, miasa am logiciel ka ho supprimena rhf fermena ny logiciel\n    /boot:  ao no misy ny fichiers mampademarre ny machine,\n            ao koa no misy ny fichiersde configuration GRUB \n    /lib:   ao no misy ny librairie izay ampiasain\'ny utilisateur\n   /sbin:  mitovtov am /bin,\n   /bin:   ato no misy ny prg apesain_user\n',NULL,NULL,NULL),(112,'#linux #filesystem #purpose_of_folder #root_folder',NULL,'\n/srv contains site-specific data which is served by this system.\n/initrd provides the capability to load a RAM disk by the boot loader\n/dev is the location of special or device files.\n  everything is a file or a directory.\n  inside this: hda1, hda2, ...  which represent the various which represent the various\n     /dev/cdrom represent your CD-ROM\n    /dev/fd0 represent floppy disk \n\n/lost+found\n  Sometimes your system might crash or a power failure might take the machine down. Either way, at the next boot, a lengthy filesystem check using fsck will be done.\n    The files recovered are not likely to be complete\n      but there always is a chance that something worthwhile is recovered\n  Each partition has its own lost+found directory\n    If you find files in there, try to move them back to their original location\n\n/mnt\n  u should mount ur devices here like cd\n    mount /dev/cdrom /mnt/cdrom\n\n/proc\n  It doesn_t contain _real_ files but runtime system information\n    e.g. system memory, devices mounted, hardware configuration, etc\n  for the information centre for the kernel\n  e.g   \'lsmod\' is the same as \'cat /proc/modules\' while \'lspci\' is a synonym for \'cat /proc/pci\'\n\n',NULL,NULL,NULL),(113,'to #extract some range of lines in file00 #sed',NULL,NULL,'sed -n 2,4p file00',NULL,NULL),(114,'#mplayer #interval_playing',NULL,NULL,NULL,'\nto run a media from 90sec and 30sec which are after\n  mplayer -ss 90 -endpos 30 file00.mp3\n',NULL),(115,'#youtube-dl #install ',NULL,NULL,NULL,'\nhttp://rg3.github.io/youtube-dl/download.html\n\n  sudo curl https://yt-dl.org/downloads/2015.01.08/youtube-dl -o /usr/local/bin/youtube-dl\n  sudo chmod a+x /usr/local/bin/youtube-dl\n',NULL),(116,'#ffprobe #install',NULL,NULL,NULL,'this is installed with ffmpeg\n  apt-get install ffmpeg\n',NULL),(117,'#os#installation',NULL,NULL,NULL,'tune2fs -l /dev/sda5 |grep  \'Filesystem created\'\n',NULL),(118,'#latest_created_file #linux #ls',NULL,NULL,'ls -1t | head -1',NULL,NULL),(119,'#linux #readlink',NULL,NULL,NULL,'readlink -f file00\n  to get the fullpath of file00',NULL),(120,'#find #linux',NULL,NULL,NULL,'find /path/folder00 -iname \'*pattern00*\'\n  to find file_folder having pattern00 in its name inside folder00',NULL),(121,'#mysql #update #append','2015-01-09 10:38:45',NULL,NULL,'\nupdate table00 set col00=concat(col00, \'appended00\') ',NULL),(122,'#pg #architecture #basis #intro\nserver and client could be on different hosts. They will communicat over tcp_ip netw connection',NULL,'\npg works on server/client\n  server is called postgres\n  client could be cli, graphical app, webserver that accesses the db',NULL,NULL,NULL),(123,'#pg #basis #intro #linux #create_db',NULL,NULL,NULL,'\ncreatedb db00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:createdb',NULL),(124,'#pg #basis #intro #linux #delete_db',NULL,NULL,NULL,'\ndropdb db00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:createdb',NULL),(125,'#pg #basis #intro #create_user',NULL,NULL,NULL,'\ncreateuser user00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:',NULL),(126,'#pg #basis #intro #delete_user',NULL,NULL,NULL,'\ndeleteuser user00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:',NULL),(127,'#pg #basis #intro #role #explanation',NULL,NULL,NULL,'\nPostgreSQL manages database access permissions using the concept of roles\nA role can be thought of as either a database user, or a group of database users,',NULL),(128,'#pg #basis #intro #exit #go_out',NULL,NULL,NULL,'\ndb0==> q\n',NULL),(129,'#pg #basis #intro #help #get_help',NULL,NULL,NULL,'\ndb0==> h\n',NULL),(130,'#pg #basis #intro #create #table',NULL,NULL,NULL,'\nCREATE TABLE weather (\n    city            varchar(80),\n    temp_lo         int,           -- low temperature\n    temp_hi         int,           -- high temperature\n    prcp            real,          -- precipitation\n    date            date\n);\n',NULL),(131,'#pg #basis #intro #auto_increment #increment #serial#primary#key',NULL,NULL,NULL,'\nCREATE TABLE foo (\nid SERIAL PRIMARY KEY,\nbar varchar);\n\nthen col(id) will auto_increment\n',NULL),(132,'#pg #basis #insert',NULL,NULL,NULL,'\nINSERT INTO COMPANY (col_int, col_str)\nVALUES (100, \'str00\');\n',NULL),(133,'#pg #basis #drop #table',NULL,NULL,NULL,'\nDROP TABLE table_name;\n',NULL),(134,'#pg #basis #show #table #show_table',NULL,NULL,NULL,'\nd;\n',NULL),(135,'#pg #basis #list #show #db #database #show_databases','2015-01-09 11:31:32',NULL,NULL,'\\list\n OR\n\\dt',NULL),(136,'#pg #describe#table ',NULL,NULL,'\n\\d+ table00;',NULL,NULL),(137,'#pg #\\G ',NULL,NULL,NULL,'\n\\x \n  then it is now activated\n  and do it again to deactivate it',NULL),(138,'#irc #search#chan #list',NULL,NULL,NULL,'/msg alis list * -topic *topic00*',NULL),(139,'#metasploit #start #intro',NULL,NULL,NULL,'remember to start #pg\n  /etc/init.d/postgresql start\nu should understand the basis of pg\n\nstart #metasploit\n  /etc/init.d/metasploit start\n  # at the first time u run that cmd, metasploit will create a db(msf3)\n  # ifk: there are many cmd in #metasploit, one of them is #msfconsole\nstart #msfconsole\n  msfconsole # cmd lin\n  # now u have the prompt of msfconsole which look like this\n  #### msf >\n\ncheck that msfconsole is connected to db(msf3)\n  msf > db_status\n',NULL),(140,'#script #linux #starting#os',NULL,NULL,NULL,'edit:/etc/rc.local\n  # put ur script on that file\n\nOR\n\nifk: if the script to run the service is in /etc/init.d/\n  then, u can do\n  update-rc.d postgresql enable\n',NULL),(141,'#set #update',NULL,NULL,'/usr/share/set/set-update\n  and it will update automatically',NULL,NULL),(142,'#ptes #intro #basics #phases #7phases',NULL,'\nThe penetration testing execution standard consists of seven (7) main sections\n  Pre-engagement Interactions\n    when you discuss the _scope and terms\n      of the pentest with ur client\n    u should _convey the goal of the pentest\n\n  Intelligence Gathering\n    gather any information you can about the organization you are attacking by using social-media networks\n    how it behaves, how it operates, and how it ultimately can be attacked.\n    that will give you valuable _insight into the types of security controls in place.\n    ex : org00 has some ports opened, then they will be used when u query sth\n      try to query sth from another port, then u will be blocked\n      _probe that way of blocking sys\n    \n  Threat Modeling\n    uses the information you acquired in the intelligence-gathering\n    Threat modeling involves looking at an organization as an adversary and attempting to exploit weaknesses as an attacker would.\n      then, try to get the most powerful attack\n    xxxxxxxxx __important__ u just define the type of attack but u don_t attack yet xxxxxxxxxxxxxxxx\n\n  Vulnerability Analysis\n    after getting the way to attack, think about \n      how will you access the target \n    _takes into account_ port and vulnerability scans\n\n  Exploitation\n    this should be done when you know almost beyond a shadow of a doubt that an exploit will be successful.\n\n  Post-Exploitation\n    begins after you have compromised one or more systems\n    where u diffentiate urself from the average \n    targets information or data that the company values most\n    When you exploit one system after another, you are trying to demonstrate attacks that would have the greatest business impact\n\n  Reporting\n    use reports to communicate what you did, how you did it, and, most impor- tant, how the organization should fix it\n    At a minimum,\n      divide your report into an \n        executive summary, \n        executive presentation, \n        and technical findings\n          will be used by the client to remediate security holes\n',NULL,NULL,NULL),(143,'#ptes #types #intro #2types',NULL,'\novert pentesting\n  u have access from the organisation to pentest the sys of the org00\n  then, u have many information about the org_target\n\ncovert pentesting\n  to attack or to simulate an attacker towards an organisation\n    without the knowledge for the org_target that they are attacked :/\n',NULL,NULL,NULL),(144,'#linux #group #list',NULL,NULL,NULL,'cut -d: -f1 /etc/group\n  that is to list all group in ur sys',NULL),(145,'#linux #user #list',NULL,NULL,NULL,'\ncut -d: -f1 /etc/passwd\n  to list all user in ur linux',NULL),(146,'#linux #user #create#useradd',NULL,NULL,NULL,'\nuseradd -d /path/home_user00 user00\n',NULL),(147,'#linux #create#user #specifi#uid#useradd',NULL,NULL,NULL,'useradd -u 127 user00',NULL),(148,'#linux #create#user #specifi#gid#useradd',NULL,NULL,NULL,'useradd -u 1000 -g 500 user00',NULL),(149,'#create#user to #multiple#groups',NULL,NULL,NULL,'useradd -G grp00,grp01,grp02 user00',NULL),(150,'#user to #check in #multiple#groups #id',NULL,NULL,NULL,'id user00',NULL),(151,'#useradd #create#user #specific#group',NULL,NULL,'useradd -G grp00 user00',NULL,NULL),(152,'#linux #make a #user #sudoer',NULL,NULL,NULL,'edit:/etc/sudoers\n  add\n  user00 ALL=(ALL) ALL\n',NULL),(153,'#linux #cut #delimiter #column',NULL,NULL,NULL,'ls -l|cut -d -f4;\n  the delimiter is whitespace after -d and take the 4th col',NULL),(154,'#nc #check #port#listening',NULL,NULL,'nc -v 192.168.20.9 80',NULL,NULL),(155,'#nc #check #port #incoming#connection',NULL,NULL,'nc -lvp 1234',NULL,NULL),(156,'#nc #connection #chat #teamviewer #cli_only',NULL,NULL,NULL,'in pc who will listen\n  nc -lvp 1234 # 1234 is a port\n\nin pc who will send txt\n  nc 127.0.0.1 1234\n\nthen the second pc can send msg to the first, \n  change 127.0.0.1 by the ip of the first pc',NULL),(157,'#python #read#interactively',NULL,NULL,NULL,'#python #read#interactively #string',NULL),(158,'#python #read#interactively #integer',NULL,NULL,NULL,'p = input(\"integer: \") \n',NULL),(159,'#update #metasploit',NULL,NULL,NULL,'sudo msfupdate',NULL),(162,'#firewall #iptable #intro',NULL,'firewall is the first line of defense\nto have a secure netw from outside attack\n  install a firewall between ur lin sys and the connection to the internet\n\nfirewall can be installed in:\n  router\n  computer',NULL,NULL,NULL),(163,'#iptables #list#rules',NULL,NULL,NULL,'iptables --list',NULL),(164,'#iptables #intro #important#object',NULL,NULL,NULL,'\nR u l e s\n======================================================================================\n  perform the packetfiltering or manipulation\n  made of several parts\n    the table to which this rule should be added\n      If no table is defined the rule will be added to the “filter” table\n    The Chain to which this rule should be added\n    The filtering or manipulation instructions\n    The target of the rule\n      This target decides what should be done with the packet if it matches the rule.\n      ex : DROP : to drop the packets if the packets matched the rule\n           ACCEPT\n           LOG  : to write sth(...) if it matched\n\nC h a i n s\n==========================================================================================\nrules are organized in “chains”\nThere are some built-in chains that are always available for the user like the INPUT or the OUTPUT in the filter_table\n\nT a b l e s\n==========================================================================================\nchains themselves are organized in so called “tables”\n\nThere are three tables available \n  filter,\n    used for packet filtering\n  nat  \n    made for all kind of “Network Address Translation” technology\n  mangle\n    designed to hold chains and rules that change other attributes of the packets or sending them into the userspace to be processed by any other application\n    this is very complex',NULL),(161,'#metasploit #architecture',NULL,'\n				  xxxxxxxx			    xxxxxxxxxxx\n                                  x  lib x              --------->  x  interf x\n				  xxxxxxxx              |           xxxxxxxxxxx\ntools    --------------->            rex		|	       console	\n			    	      ^			|		\n				      |			|		cli\n				   msfcore              |\n				      ^			|		web\n				      |                 |\nplugins  --------------->          msfbase    <---------|		gui\n				      ^             \n				      |\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\nx                                  modules					x\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\npayloads    |      exploits      |      encoders      |      nops      |      aux\n',NULL,NULL,NULL),(165,'#firewall #iptable #intro #basic#functionalities',NULL,'\nthose are some basic functionnality of firewall \n  Stealth Mode - Discarding Pings\n  bcz ping can find out if a particular sys is up\n    it can be discarded\n\n   Port Forwarding and Blocking\n     the most fundamental level of firewall security and will be the most used\n\n  Packet Filtering\n    much more advanced mechanism for providing security and is not available in typical small business or home use router devices\n',NULL,NULL,NULL),(166,'#metasploit #architecture',NULL,'many libs are used to keep msf functioning, the most important is (part of the framework) REX(ruby extension) lib\nmsf_core lib extends rex',NULL,NULL,NULL),(167,'#metasploit #interface',NULL,'\n/usr/share/metasploit-framework/msfgui\n  for the gui of msf\n/usr/share/metasploit-framework/msfconsole   for the console of msf  they are right for kali-linux1.0.8 ',NULL,NULL,NULL),(168,'#msf #save_to#db #db_nmap #scan',NULL,NULL,NULL,'msf > db_nmap 192.168.56.102',NULL),(169,'#mysql #create#procedure #basic',NULL,NULL,NULL,'\ndelimiter |\nCREATE PROCEDURE proc00()\nbegin\n...\nend|\n',NULL),(170,'#mysql #procedure #proc #call',NULL,NULL,NULL,'call proc00()',NULL),(171,'#mysql #procedure #proc #parameter #argument #in',NULL,NULL,NULL,'\nCREATE PROCEDURE proc00 (IN param00 INT)\nbegin\n...\nend\n',NULL),(172,'#mysql #procedure #proc #parameter #argument#in #call',NULL,NULL,NULL,'call proc00(1)\nOR\nSET @var00 := 2;\ncall proc00(@var00)\n',NULL),(173,'#mysql #procedure #proc #parameter #argument',NULL,NULL,NULL,'\nCREATE PROCEDURE proc00 (IN param00 INT, OUT param01 int)\nbegin\n...\nend\n',NULL),(174,'#mysql #conf #activate#log',NULL,NULL,NULL,'edit:/etc/mysql/my.cnf, add\n  [mysql]\n  general_log_file        = /var/log/mysql/mysql.log\n  general_log             = 1\n',NULL),(175,'#definition #pen_testing',NULL,'Penetration Testing goes beyond an assessment by evaluating identified vulnerabilities\nA Penetration Test would attempt to attack those vulnerabilities in the same manner as a malicious hacker to verify which vulnerabilities are genuine reducing the real list of system vulnerabilities\n\n\nPenetration Testing does not make networks more secure!\nPenetration Testing evaluates the effectiveness of existing security\nIf\nIf a customer does not have strong security then they will receive little value from Penetration Testing services ',NULL,NULL,NULL),(176,'#ptes #terminology #methodology',NULL,'The most common terminology defining the starting state is Black box testing, White box testing, or a blend between White and Black box testing known as Gray box testing\n\nBlack box assumes the Penetration Tester has no prior knowledge of the target\nStarting a Black box project requires a lot of reconnaissance\n\nWhite box is when a Penetration Tester has intimate knowledge about the system.\n\ngray box is between white and blackbox\n\nAn internal security group usually performs white box testing',NULL,NULL,NULL),(177,'#git #add #remote#repo',NULL,NULL,'git remote add origin https://github.com/user/repo.git',NULL,NULL),(178,'#git #version #check',NULL,NULL,'git --version',NULL,NULL),(179,'#git #remote#repo #tip',NULL,'\nedit: .git/config\n  change: url=https://MichaelDrogalis@github.com/derekerdmann/lunch_call.git\n  to:     url=ssh://git@github.com/derekerdmann/lunch_call.git\n',NULL,NULL,NULL),(180,'#git #mail #add #global',NULL,NULL,NULL,'git config --global user.email \"your_email@youremail.com\"',NULL),(181,'#git #add #username #name #global',NULL,NULL,NULL,'git config --global user.name \"Firstname Lastname\"',NULL),(186,'#pentest #methodology#think_about',NULL,'Definition of Target System(s)\n  the location on the network, types of systems, and business of those systems\n\nTimeframe of the testing\n  \nHow Targets Are Evaluated\n  What types of testing, exploitation are not permitted\n  Examples are; using social networking by pretending to be an employee\n\nTools and software\n\nnotified parties\n  may s1 should be informed about the test\n\nInitial Access Level\n  What type of information and access is provided prior to _kicking off_ the Penetration Test?\n\nDefinition of Target Space\n\nIdentification of Critical Operation Areas\n  which area should not be touched\n\nDeliverable:\n  What type of final report is expected?\n  Remediation expectations:\n\n',NULL,NULL,NULL);
...
-- Dump completed on 2015-01-11  9:08:12
