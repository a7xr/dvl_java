...
INSERT INTO `notes_tech` VALUES (1,'#crontab do not forget to add ; after all command in crontab',NULL,'not mentioned',NULL,NULL,'-p 12 /srv/doc/h/webPenTestWithKali.pdf',NULL,'0000-00-00 00:00:00'),(2,'#git hooks in git is used for scripting about the local repo',NULL,'not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(3,'#git #central #important files:HEAD index objects refs',NULL,'not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(4,'#git #refs stocke les pointeurs vers les objets',NULL,'not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(5,'#git #head pointe sur le branche qui est en cours',NULL,'not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(8,'#if [ -z \"$1\" ]','true if $1 is null','not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(9,'\nthis is a tes of \nhow to do it \n',NULL,'not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(10,'#if [ -n \"$1\" ]','this is true if $1 is NOT null','not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(11,'#mysql #for a in $(mysql_out_w/only_one_col) ; do ..... ; done','this is how to #scan a result of mysql_select\n  ex:\n    for valXX in $(msql \"select note from notes;\")\n    do\n      echo $valXX\n    done\n','not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(12,'#script #bash #policy #var_name','\nthose are some policy for variable name in #bash\n  error_var have to start with e_xxx\n','not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(13,'#script #bash #policy #body_of_script','\n\nshabang\nsome description of the script\nvariables which will be used in the body of the script\ntreat the error which can be caught by the script like error in argument\n....\nbody\n....\nexit X\n','not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(14,'#git #reset #commit but _without_ changing the modification in file',NULL,'git reset HEAD^',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(15,'#git #reset #commit WITH cancelling the modification in file',NULL,'git reset --hard HEAD^',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(16,'#git #cancel #modification #ifk like #stash to go back in the modif of a file which has been commited',NULL,'git checkout file00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(17,'#git #cancel #add in tracking',NULL,'git reset HEAD -- file00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(19,'#git #revert','if u made a push to the server\n  it is not possible to cancel definetely that push\n  u have to make a new push which revert the previous push','git revert 45444cz',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(20,'#git #branch #create',NULL,'git branch new_branch00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(21,'#git #branch #utility','branch: il y a des modification que vous voulez faire mais vous n_etes pas sure des modification...... 1-stoppez et commitez par la ou vous etes sures que le code marche.... 2-creez une branche (@this__id_n_t=20)....3-passez dans une autre branche grace a git checkout branch00\n','not mentioned',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(22,'#git #branch #fusion #merge','pour fusionner une branche avec la branche master..... va dans la branch master d_abord(__git checkout master__)... faite la fusion(__git merge branch00__)','git merge branch00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(23,'#git #branch #delete ','\nu did a fusion to branch00 to branch_master\nu want to delete branch00(__git branch -d branch00__)','git branch -d branch00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(24,'#git #branch #check ','\nto see what are the branch which are in ur repo','git branch',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(25,'#git #branch #delete without merging to master ',NULL,'git branch -D branch00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(26,'#git #stash ','u wanted to change to another branch but u made a modif in the current_br which is NOT commited, u don_t want to commit bcz it is a small changement........ u have to stash........then check the stash list(__git stash list__)...... to go back in the previ modif (__git stash apply stash@{5}__) that is for instance','git stash',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(27,'#git #stash ','to remove some stash which is being saved.... note that a stash is a saving which is not commited','git stash drop stash@{2}',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(28,'#mysql #rename_table','the title explains everything','rename table db00.table00 to db00.newName',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(29,'#mysql #rename_user','the title explains everything','rename user \"user00\"@\"host00\" to \"user01\"@\"host01\"',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(30,'#mysql #change_pass','the user00 must be logged into mysql;....the title explains everything','set password for \"user00\"@\"host00\" = password(\"your new pass\")',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(31,'#sed #intro','sed fonctionne en mode line par line',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(32,'#sed #intro','sed fonctionne en mode line par line\ncela a des bonnes et des mauvaises consequences',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(33,'#sed #intro','sed s\'utilise de deux facons\n  classique : on exe une cmd_sed sur un fichier puis on recupere la sortie sur une autre fichier \n  directe : on exe une cmd_sed sur un fichier puis le resultat s\'applique sur le fichier passee en entree',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(34,'#sed #intro','sed peut recevoir un script:\n  il y a 2facons de passer un scrip a sed:\n    sed -e __ici_le_script_uniligne__\n    sed -f __script_file__',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(35,'#sed #important #basis','2014-12-19 17:04:40','','\nsed -e __script_uniline__\n  ex: sed -e \'4d; 7d \' test.txt                 \n    -e : for the fact that the script \'4d; 7d \' will be performed in file_test.txt\n    -d : to delete\n      so \'4d; 7d \' meant to delete the line 4 AND 7    \n\n  ex : sed -e \'4,7 d\' test.txt\n  	to delete the line from 4 TILL 7\n\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(36,'#sed #regex #intro',NULL,NULL,'\nsed \'/^# / d\' test.txt',NULL,NULL,NULL,'0000-00-00 00:00:00'),(37,'#mysql #cluster #introduction #nodes','MySQL Clusters are built from three different types of node.\n  cluster = sum(3nodes)\n  3nodes:\n    management node\n    storage node\n    api node\n      used to extract data from db\n      most common is __mysqld__\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(38,'#mysql #cluster #install','\nu have to dl and install 2files\n  MySQL-Cluster-gpl-server-7.a.b-c.rhel5.x86_64.rpm\n  	this is about the server of the cluster\n  MySQL-client-community-5.a.b-c.rhel5.x86_64.rpm   	this is about the client of the cluster  \n\nafter installing these rpms, a file is created:\n  /etc/my.cnf\n\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(39,'#mysql #status check','\n$ service mysql status\nOR\n$ /etc/init.d mysql status\nOR\n$ telnet host00 3306\n  this is check if the server is up\n    and listening for connections on the port\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(40,'#mysql #log check','\nthe file of log is in:\n  /var/log/mysql/mysql.log\n    that is defined on the confFile in #general-log-file',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(41,'#sec #iptables #intro','u really need iptables to filter traffic which are permitted in ur serv\n  without ipt all traffics are almost allowed which is not good ',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(42,'#sec #iptables #intro #firewall','firewall do the analyse all packets.. do they respect the rules',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(43,'#sec #iptables #intro #firewall','criteria of filter are many: ports, protocols, addrIP, and more\n\niptables is very strict. then, if u want to activate iptables, u have to block everything, and right after, open what u want little by little',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(44,'#sec #log #auth #sys','to see who was logged into ur sys','/var/log/auth.log',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(45,'#sec #log #stuff #sys','stuff of log... errors, bugs, informations, .....','/var/log/message\n/var/log/syslog',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(46,'#sec #log #fail2ban','log of fail2ban... ','/var/log/fail2ban',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(47,'#sec #log #snort','log of snort... ','/var/log/snort/alert',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(48,'#sec #log #rkhunter','log of rkhunter... ','/var/log/rkhunter',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(49,'#sec #rkhunter #intro','if someone hacked ur sys, maybe he installed a backdoor in ur sys then he can rehack ur sys, and a rootkit to hide the hack\n\nrkhunter can detect rootkits on the server ',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(50,'#sec #conf #rkhunter','configuration_file of rkhunter','/etc/default/rkhunter',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(51,'#sec #intro','firewall had to block some connections, but the connections which are opened had to be controlled too,....\n  then we have ids (intrusion detection sys) and ips (intrustion prevention sys)\n    they are types of software which will detect all attempt of intrusion',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(52,'#sec #intro','those are the steps to do a classic intrusion:\n  scan port\n  simple attack\n  intrusion\n  how to log in the server on the purpose',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(53,'#sec #intro #portsentry','\nto block|manage who can scan ur port',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(54,'#sec #conf_file #portsentry','conf file of #portsentry','/usr/local/psionic/portsentry/portsentry.conf',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(55,'#sec #conf_file #portsentry','conf file of #portsentry','/etc/portsentry/portsentry.conf',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(57,'#sec #fail2ban #intro','\nit is based on blocking ip which tried to log into some services and which it was failed\n  it will block the ip with iptables',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(58,'#sec #fail2ban #conf',NULL,'/etc/fail2ban/jail.conf',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(59,'#sec #snort #intro','it is powerful and analyse the traffic in live, then ur sys can slow down with this\nhttp://www.trustonme.net/didactels/187.html\nhttp://doc.ubuntu-fr.org/snort\n    \n when bug appears, check /var/log/syslog\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(60,'#sec #log #logwatch #conf_file',NULL,'/usr/share/logwatch/default.conf/logwatch.conf',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(61,'#sys #conf_file #ssh',NULL,'/etc/ssh/sshd_config',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(62,'#sys #conf_file #apache2',NULL,'/etc/apache2/apache2.conf',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(63,'#nmap','to scan port on a server and to make it verbose','nmap -v ip00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(64,'#nessus #intro #sec','to scan vulnerabilities in ur sys',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(65,'#osi #memo #aide_memo','all people seems to need data processing\nOR\nplease, do not throw sausage pizza away',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(66,'#mysql #query #ifnull','this will select col00 and col01, but if col01 is null then it will be replaced by \'newVal\'','select col00, IFNULL(col01,\'newVal\')',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(67,'#postfix #conf_file',NULL,'/etc/postfix/main.cf',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(68,'#postfix #package_to_install',NULL,'postfix postfix-mysql libasl2-2 libasl2-modules sasl2-bin libpam-mysql procmail',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(69,'#cisco #basis #intro #info #default','by default, all pc connected to sw are in vlan1. u can check it by: sw#show vlan',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(70,'#cisco #create_vlan','sw_conf#vlan 15\nxxxxxx#name vlanName\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(71,'#bash #preserve_space #space','\njust put ur string inside \"\"\nor inside \'\'\n  ex: echo \' this preserve space \'\n  ex: echo this will    not preserve     the space \n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(72,'#bash #printf #basis','\nprintf \'%s = %d\n\' lines: $line\nout__\n  lines: 245\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(73,'#bash #echo #newline_no','echo -n \'this need \n to do a newline\'',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(74,'#bash #echo #character_special','echo -e \'u can write here sth like \n to make a newline......do not forget the -e with echo\'',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(75,'#linux #ls','to write the result only one file per line ','ls -1',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(76,'#linux #basic #output','to write normal_out of a cmd to file01 and the error_out of a cmd to file02','cmd00 1>fileForNormal 2>fileForError',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(77,'#linux #basic #output #same_file','to write normal_out and error of a cmd to file01 ','cmd00 &> fileForNormAndErr',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(78,'#linux #tail',NULL,NULL,'\nthis is to print from the bottom of the file00\n  ex: tail file00\n    will print the 10last lines of file00\n  ex: tail -n 25 \n    will print the 25last lines of file00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(79,'#git #ignore_file','\nadd the files in .gitignore',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(80,'#git #list #tag','the order of the result do not tell as well the ?historic of the tag','git tag',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(81,'#git #list #tag #specification','to list all v1.4.1 ... v1.4.5 ... v1.4.10000','git tag -l \'v1.4.*\'',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(82,'#git #tag #types','\n2types of git_tag:\n  light:\n    almost like branch, doesn_t change\n  noted\n    stored as an object, stored in db of git\n    could checked and signed by gnu_guard\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(83,'#git #tag #create',NULL,NULL,'git tag -a v1.0.2 -m \'this is the comment of the tag\' \n	\n	-a	:	to create the tag\n	-m	:	to set a comment for the tag\n\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(84,'#git #tag #show',NULL,'git show v1.5',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(85,'#git #tagging_after_commit #baliser_apres_coup',NULL,NULL,'git tag -a v1.2 9fec56',NULL,NULL,NULL,'0000-00-00 00:00:00'),(86,'#git #push #all_tag #tag',NULL,NULL,'git push origin --tags\n  that is to push all tags into remote server',NULL,NULL,NULL,'0000-00-00 00:00:00'),(87,'#git #install on #windows','\nu have to install msysgit\n  http://code.google.com/p/msysgit',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(88,'#pg #basic #intro','\nto create a new db\n  in ur sys, u have to be the user postgres\n  $ createdb db00\nnow it is created\nto connect to it, u have to be the user postgres to do this\n  $ psql db00\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(89,'#linux #read #end_of_file #eof',NULL,NULL,'\nread << eof\n  u will type sth till u type eof\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(90,'#bash #case #basic','\n#decl_var\n# all variables which u will use in ur script should be declared before the body of the function \nlocal choice ;\nlocal answer=\' ;\nlocal question=\'do u want to play a game ? [y/n]\'\nread -p \"$question\" answer\ncase \"$answer\" in\n	[yY] ) choice=\'y\' ;;\n	[nN] ) choice=\'n\' ;;\n	*	 ) choice=\"$answer\"\n		# here if the answer is different than y/n\nesac\n\n\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(91,'#bash #arithmetic #operation',NULL,NULL,'\n# declaration of variable\ndeclare -i var00\nvar00=$((5+9))\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(92,'#bash #give_value_if_null',NULL,NULL,'\n${var00:=\'default_val\'}',NULL,NULL,NULL,'0000-00-00 00:00:00'),(93,'#bash #give_value_if_null',NULL,NULL,'\n${var00:=\'default_val\'}\n${var00:=\"$(pwd)\"}\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(94,'#mysql #offset #limit #query',NULL,NULL,'\nselect * from table00 limit 5 offset 10\n  the query will start from the result number_10\n  and will show 5 rows only',NULL,NULL,NULL,'0000-00-00 00:00:00'),(96,'#bash #declare_var_type #type',NULL,NULL,'\nto declare an integer \n  then u can compare the variable using -ge or -lt or .......\n    $ declare -i varInt\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(97,'#mysql #dummy #safe-update #update',NULL,NULL,'edit:/etc/mysql/my.cnf\n  [mysql]\n  safe-updates\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(98,'#mysql #date #day',NULL,NULL,'to get the day, and some info of today\n  select day(now());\n    val: 1-31\n  dayofweek()\n    val: 1 = sunday\n         ...\n         7 = saturday\n  dayname()\n    val: Thursday, Monday, ......\n  dayofyear\n    val: 1 - 366\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(99,'#mysql #date #str_to_date',NULL,NULL,'\nselect str_to_date(\'2015-11-28\', \'%Y-%m-%d\');\n  %Y  year\n    YYYY\n  %m  month\n    mm\n  %d  day\n    dd\n  %y  year\n    yy\n  %h  hour\n    hh\n  %i  mn\n    ii\n  %s  sec\n    ss\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(100,'#mysql #save_all_db_in_server #server #save',NULL,NULL,'\n$ mysqldump --user=root --password --all-databases > dump.sql\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(101,'#mysql #save_table_into_file00.sql #table #save',NULL,NULL,'\n$ mysqldump --user=root --password db00 table00 > table00.sql\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(102,'#mysql #select #save #outfile',NULL,NULL,'select * from table00 into outfile \'/path/file00\'',NULL,NULL,NULL,'0000-00-00 00:00:00'),(103,'\n#lvm #intro ','3 basic terms:\n  physical volume \n    any block device. hdd or software_RAID_volume\n  volume group\n    collection of physical volume\n    physical volume can be added or removed from volume_group\n  logical volume\n    volume_group doesn_t have OS on it, then it needs logical_volume\n    used to mount, create file sys\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(104,'#linux #grub #version #check',NULL,NULL,'grub-install --version',NULL,NULL,NULL,'0000-00-00 00:00:00'),(105,'#linux #grub #change_bg #background #bg','edit:/etc/default/grub\n  GRUB_BACKGROUND=\"/path/img00.png\"\n  sudo update-grub\n\nthat worked on grub_1.99-26',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(106,'#mysql #change_pass #pwd #password','set password=password(\'pass00\')',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(107,'#linux #mmt #reinit_kali #kali #os',NULL,NULL,'those folders should be set when I just installed a new linuxOS\n  /repos\n  /opt\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(108,'#irc #log_in #identify',NULL,NULL,'/msg nickserv identify pseudo00 pass00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(109,'#mysql #order_by',NULL,NULL,'SELECT col01, col02, col03, col04 FROM driver_log ORDER BY 3',NULL,NULL,NULL,'0000-00-00 00:00:00'),(110,'#linux #firefox #ff #flash #install',NULL,'','\n  ø dl: http://get.adobe.com/flashplayer/\n  ø extract the .tar.gz \n  ø cp libflashplayer.so /usr/lib/mozilla/plugins/\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(111,'#linux #filesystem #purpose_of_folder #root_folder','\n/dev:   raha hiAcceder peripherique: partitions, disk, carte son, ports SCSI, ...\n    /etc:   ato ny daholo ny fichiers de configuration des logiciels\n    /media: fimontena peripherique amovible(ho an\'ny OS sasany)\n     /usr:   fisian\'ny fichier hoPartagena en reseau, na natao en lecture seule\n    /opt:   misy ny apps complementaire, izan hoe tsy anle distro installee\n    /var:   ao no misy ny fichiers temporaires, miasa am logiciel ka ho supprimena rhf fermena ny logiciel\n    /boot:  ao no misy ny fichiers mampademarre ny machine,\n            ao koa no misy ny fichiersde configuration GRUB \n    /lib:   ao no misy ny librairie izay ampiasain\'ny utilisateur\n   /sbin:  mitovtov am /bin,\n   /bin:   ato no misy ny prg apesain_user\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(112,'#linux #filesystem #purpose_of_folder #root_folder','\n/srv contains site-specific data which is served by this system.\n/initrd provides the capability to load a RAM disk by the boot loader\n/dev is the location of special or device files.\n  everything is a file or a directory.\n  inside this: hda1, hda2, ...  which represent the various which represent the various\n     /dev/cdrom represent your CD-ROM\n    /dev/fd0 represent floppy disk \n\n/lost+found\n  Sometimes your system might crash or a power failure might take the machine down. Either way, at the next boot, a lengthy filesystem check using fsck will be done.\n    The files recovered are not likely to be complete\n      but there always is a chance that something worthwhile is recovered\n  Each partition has its own lost+found directory\n    If you find files in there, try to move them back to their original location\n\n/mnt\n  u should mount ur devices here like cd\n    mount /dev/cdrom /mnt/cdrom\n\n/proc\n  It doesn_t contain _real_ files but runtime system information\n    e.g. system memory, devices mounted, hardware configuration, etc\n  for the information centre for the kernel\n  e.g   \'lsmod\' is the same as \'cat /proc/modules\' while \'lspci\' is a synonym for \'cat /proc/pci\'\n\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(113,'to #extract some range of lines in file00 #sed',NULL,'sed -n 2,4p file00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(114,'#mplayer #interval_playing',NULL,NULL,'\nto run a media from 90sec and 30sec which are after\n  mplayer -ss 90 -endpos 30 file00.mp3\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(115,'#youtube-dl #install ',NULL,NULL,'\nhttp://rg3.github.io/youtube-dl/download.html\n\n  sudo curl https://yt-dl.org/downloads/2015.01.08/youtube-dl -o /usr/local/bin/youtube-dl\n  sudo chmod a+x /usr/local/bin/youtube-dl\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(116,'#ffprobe #install',NULL,NULL,'this is installed with ffmpeg\n  apt-get install ffmpeg\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(117,'#os#installation',NULL,NULL,'tune2fs -l /dev/sda5 |grep  \'Filesystem created\'\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(118,'#latest_created_file #linux #ls',NULL,'ls -1t | head -1',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(119,'#linux #readlink',NULL,NULL,'readlink -f file00\n  to get the fullpath of file00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(120,'#find #linux',NULL,NULL,'find /path/folder00 -iname \'*pattern00*\'\n  to find file_folder having pattern00 in its name inside folder00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(121,'#mysql #update #append',NULL,NULL,'\nupdate table00 set col00=concat(col00, \'appended00\') ',NULL,NULL,NULL,'0000-00-00 00:00:00'),(122,'#pg #architecture #basis #intro\nserver and client could be on different hosts. They will communicat over tcp_ip netw connection','\npg works on server/client\n  server is called postgres\n  client could be cli, graphical app, webserver that accesses the db',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(123,'#pg #basis #intro #linux #create_db',NULL,NULL,'\ncreatedb db00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:createdb',NULL,NULL,NULL,'0000-00-00 00:00:00'),(124,'#pg #basis #intro #linux #delete_db',NULL,NULL,'\ndropdb db00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:createdb',NULL,NULL,NULL,'0000-00-00 00:00:00'),(125,'#pg #basis #intro #create_user',NULL,NULL,'\ncreateuser user00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:',NULL,NULL,NULL,'0000-00-00 00:00:00'),(126,'#pg #basis #intro #delete_user',NULL,NULL,'\ndeleteuser user00 # that is a linux cmd\n  remember that the _root_ of pg_db is called: postgres\n  then before doing the previous cmd, do this one\n    su postgres\n  then do the previous cmd:',NULL,NULL,NULL,'0000-00-00 00:00:00'),(127,'#pg #basis #intro #role #explanation',NULL,NULL,'\nPostgreSQL manages database access permissions using the concept of roles\nA role can be thought of as either a database user, or a group of database users,',NULL,NULL,NULL,'0000-00-00 00:00:00'),(128,'#pg #basis #intro #exit #go_out',NULL,NULL,'\ndb0==> q\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(129,'#pg #basis #intro #help #get_help',NULL,NULL,'\ndb0==> h\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(130,'#pg #basis #intro #create #table',NULL,NULL,'\nCREATE TABLE weather (\n    city            varchar(80),\n    temp_lo         int,           -- low temperature\n    temp_hi         int,           -- high temperature\n    prcp            real,          -- precipitation\n    date            date\n);\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(131,'#pg #basis #intro #auto_increment #increment #serial#primary#key',NULL,NULL,'\nCREATE TABLE foo (\nid SERIAL PRIMARY KEY,\nbar varchar);\n\nthen col(id) will auto_increment\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(132,'#pg #basis #insert',NULL,NULL,'\nINSERT INTO COMPANY (col_int, col_str)\nVALUES (100, \'str00\');\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(133,'#pg #basis #drop #table',NULL,NULL,'\nDROP TABLE table_name;\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(134,'#pg #basis #show #table #show_table',NULL,NULL,'\nd;\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(135,'#pg #basis #list #show #db #database #show_databases',NULL,NULL,'\\list\n OR\n\\dt',NULL,NULL,NULL,'0000-00-00 00:00:00'),(136,'#pg #describe#table ',NULL,'\n\\d+ table00;',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(137,'#pg #\\G ',NULL,NULL,'\n\\x \n  then it is now activated\n  and do it again to deactivate it',NULL,NULL,NULL,'0000-00-00 00:00:00'),(138,'#irc #search#chan #list',NULL,NULL,'/msg alis list * -topic *topic00*',NULL,NULL,NULL,'0000-00-00 00:00:00'),(139,'#metasploit #start #intro',NULL,NULL,'remember to start #pg\n  /etc/init.d/postgresql start\nu should understand the basis of pg\n\nstart #metasploit\n  /etc/init.d/metasploit start\n  # at the first time u run that cmd, metasploit will create a db(msf3)\n  # ifk: there are many cmd in #metasploit, one of them is #msfconsole\nstart #msfconsole\n  msfconsole # cmd lin\n  # now u have the prompt of msfconsole which look like this\n  #### msf >\n\ncheck that msfconsole is connected to db(msf3)\n  msf > db_status\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(140,'#script #linux #starting#os',NULL,NULL,'edit:/etc/rc.local\n  # put ur script on that file\n\nOR\n\nifk: if the script to run the service is in /etc/init.d/\n  then, u can do\n  update-rc.d postgresql enable\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(141,'#set #update',NULL,'/usr/share/set/set-update\n  and it will update automatically',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(142,'#ptes #intro #basics #phases #7phases','\nThe penetration testing execution standard consists of seven (7) main sections\n  Pre-engagement Interactions\n    when you discuss the _scope and terms\n      of the pentest with ur client\n    u should _convey the goal of the pentest\n\n  Intelligence Gathering\n    gather any information you can about the organization you are attacking by using social-media networks\n    how it behaves, how it operates, and how it ultimately can be attacked.\n    that will give you valuable _insight into the types of security controls in place.\n    ex : org00 has some ports opened, then they will be used when u query sth\n      try to query sth from another port, then u will be blocked\n      _probe that way of blocking sys\n    \n  Threat Modeling\n    uses the information you acquired in the intelligence-gathering\n    Threat modeling involves looking at an organization as an adversary and attempting to exploit weaknesses as an attacker would.\n      then, try to get the most powerful attack\n    xxxxxxxxx __important__ u just define the type of attack but u don_t attack yet xxxxxxxxxxxxxxxx\n\n  Vulnerability Analysis\n    after getting the way to attack, think about \n      how will you access the target \n    _takes into account_ port and vulnerability scans\n\n  Exploitation\n    this should be done when you know almost beyond a shadow of a doubt that an exploit will be successful.\n\n  Post-Exploitation\n    begins after you have compromised one or more systems\n    where u diffentiate urself from the average \n    targets information or data that the company values most\n    When you exploit one system after another, you are trying to demonstrate attacks that would have the greatest business impact\n\n  Reporting\n    use reports to communicate what you did, how you did it, and, most impor- tant, how the organization should fix it\n    At a minimum,\n      divide your report into an \n        executive summary, \n        executive presentation, \n        and technical findings\n          will be used by the client to remediate security holes\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(143,'#ptes #types #intro #2types','\novert pentesting\n  u have access from the organisation to pentest the sys of the org00\n  then, u have many information about the org_target\n\ncovert pentesting\n  to attack or to simulate an attacker towards an organisation\n    without the knowledge for the org_target that they are attacked :/\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(144,'#linux #group #list',NULL,NULL,'cut -d: -f1 /etc/group\n  that is to list all group in ur sys',NULL,NULL,NULL,'0000-00-00 00:00:00'),(145,'#linux #user #list',NULL,NULL,'\ncut -d: -f1 /etc/passwd\n  to list all user in ur linux',NULL,NULL,NULL,'0000-00-00 00:00:00'),(146,'#linux #user #create#useradd',NULL,NULL,'\nuseradd -d /path/home_user00 user00\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(147,'#linux #create#user #specifi#uid#useradd',NULL,NULL,'useradd -u 127 user00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(148,'#linux #create#user #specifi#gid#useradd',NULL,NULL,'useradd -u 1000 -g 500 user00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(149,'#create#user to #multiple#groups',NULL,NULL,'useradd -G grp00,grp01,grp02 user00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(150,'#user to #check in #multiple#groups #id',NULL,NULL,'id user00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(151,'#useradd #create#user #specific#group',NULL,'useradd -G grp00 user00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(152,'#linux #make a #user #sudoer',NULL,NULL,'edit:/etc/sudoers\n  add\n  user00 ALL=(ALL) ALL\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(153,'#linux #cut #delimiter #column',NULL,NULL,'ls -l|cut -d -f4;\n  the delimiter is whitespace after -d and take the 4th col',NULL,NULL,NULL,'0000-00-00 00:00:00'),(154,'#nc #check #port#listening',NULL,'nc -v 192.168.20.9 80',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(155,'#nc #check #port #incoming#connection',NULL,'nc -lvp 1234',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(156,'#nc #connection #chat #teamviewer #cli_only',NULL,NULL,'in pc who will listen\n  nc -lvp 1234 # 1234 is a port\n\nin pc who will send txt\n  nc 127.0.0.1 1234\n\nthen the second pc can send msg to the first, \n  change 127.0.0.1 by the ip of the first pc',NULL,NULL,NULL,'0000-00-00 00:00:00'),(157,'#python #read#interactively',NULL,NULL,'#python #read#interactively #string',NULL,NULL,NULL,'0000-00-00 00:00:00'),(158,'#python #read#interactively #integer',NULL,NULL,'p = input(\"integer: \") \n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(159,'#update #metasploit',NULL,NULL,'sudo msfupdate',NULL,NULL,NULL,'0000-00-00 00:00:00'),(162,'#firewall #iptable #intro','firewall is the first line of defense\nto have a secure netw from outside attack\n  install a firewall between ur lin sys and the connection to the internet\n\nfirewall can be installed in:\n  router\n  computer',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(163,'#iptables #list#rules',NULL,NULL,'iptables --list',NULL,NULL,NULL,'0000-00-00 00:00:00'),(164,'#iptables #intro #important#object',NULL,NULL,'\nR u l e s\n======================================================================================\n  perform the packetfiltering or manipulation\n  made of several parts\n    the table to which this rule should be added\n      If no table is defined the rule will be added to the “filter” table\n    The Chain to which this rule should be added\n    The filtering or manipulation instructions\n    The target of the rule\n      This target decides what should be done with the packet if it matches the rule.\n      ex : DROP : to drop the packets if the packets matched the rule\n           ACCEPT\n           LOG  : to write sth(...) if it matched\n\nC h a i n s\n==========================================================================================\nrules are organized in “chains”\nThere are some built-in chains that are always available for the user like the INPUT or the OUTPUT in the filter_table\n\nT a b l e s\n==========================================================================================\nchains themselves are organized in so called “tables”\n\nThere are three tables available \n  filter,\n    used for packet filtering\n  nat  \n    made for all kind of “Network Address Translation” technology\n  mangle\n    designed to hold chains and rules that change other attributes of the packets or sending them into the userspace to be processed by any other application\n    this is very complex',NULL,NULL,NULL,'0000-00-00 00:00:00'),(161,'#metasploit #architecture','\n				  xxxxxxxx			    xxxxxxxxxxx\n                                  x  lib x              --------->  x  interf x\n				  xxxxxxxx              |           xxxxxxxxxxx\ntools    --------------->            rex		|	       console	\n			    	      ^			|		\n				      |			|		cli\n				   msfcore              |\n				      ^			|		web\n				      |                 |\nplugins  --------------->          msfbase    <---------|		gui\n				      ^             \n				      |\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\nx                                  modules					x\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\npayloads    |      exploits      |      encoders      |      nops      |      aux\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(165,'#firewall #iptable #intro #basic#functionalities','\nthose are some basic functionnality of firewall \n  Stealth Mode - Discarding Pings\n  bcz ping can find out if a particular sys is up\n    it can be discarded\n\n   Port Forwarding and Blocking\n     the most fundamental level of firewall security and will be the most used\n\n  Packet Filtering\n    much more advanced mechanism for providing security and is not available in typical small business or home use router devices\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(166,'#metasploit #architecture','many libs are used to keep msf functioning, the most important is (part of the framework) REX(ruby extension) lib\nmsf_core lib extends rex',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(167,'#metasploit #interface','\n/usr/share/metasploit-framework/msfgui\n  for the gui of msf\n/usr/share/metasploit-framework/msfconsole   for the console of msf  they are right for kali-linux1.0.8 ',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(168,'#msf #save_to#db #db_nmap #scan',NULL,NULL,'msf > db_nmap 192.168.56.102',NULL,NULL,NULL,'0000-00-00 00:00:00'),(169,'#mysql #create#procedure #basic',NULL,NULL,'\ndelimiter |\nCREATE PROCEDURE proc00()\nbegin\n...\nend|\n\ndo not do the creation of a procedure inside \\e of mysql',NULL,NULL,NULL,'0000-00-00 00:00:00'),(170,'#mysql #procedure #proc #call',NULL,NULL,'call proc00()',NULL,NULL,NULL,'0000-00-00 00:00:00'),(171,'#mysql #procedure #proc #parameter #argument #in',NULL,NULL,'\nCREATE PROCEDURE proc00 (IN param00 INT)\nbegin\n...\nend\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(172,'#mysql #procedure #proc #parameter #argument#in #call',NULL,NULL,'call proc00(1)\nOR\nSET @var00 := 2;\ncall proc00(@var00)\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(173,'#mysql #procedure #proc #parameter #argument',NULL,NULL,'\nCREATE PROCEDURE proc00 (IN param00 INT, OUT param01 int)\nbegin\n...\nend\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(174,'#mysql #conf #activate#log',NULL,NULL,'edit:/etc/mysql/my.cnf, add\n  [mysql]\n  general_log_file        = /var/log/mysql/mysql.log\n  general_log             = 1\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(175,'#definition #pen_testing','Penetration Testing goes beyond an assessment by evaluating identified vulnerabilities\nA Penetration Test would attempt to attack those vulnerabilities in the same manner as a malicious hacker to verify which vulnerabilities are genuine reducing the real list of system vulnerabilities\n\n\nPenetration Testing does not make networks more secure!\nPenetration Testing evaluates the effectiveness of existing security\nIf\nIf a customer does not have strong security then they will receive little value from Penetration Testing services ',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(176,'#ptes #terminology #methodology','The most common terminology defining the starting state is Black box testing, White box testing, or a blend between White and Black box testing known as Gray box testing\n\nBlack box assumes the Penetration Tester has no prior knowledge of the target\nStarting a Black box project requires a lot of reconnaissance\n\nWhite box is when a Penetration Tester has intimate knowledge about the system.\n\ngray box is between white and blackbox\n\nAn internal security group usually performs white box testing',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(177,'#git #add #remote#repo',NULL,'git remote add origin https://github.com/user/repo.git',NULL,'aa02',NULL,NULL,'0000-00-00 00:00:00'),(178,'#git #version #check',NULL,'git --version',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(179,'#git #remote#repo #tip','\nedit: .git/config\n  change: url=https://MichaelDrogalis@github.com/derekerdmann/lunch_call.git\n  to:     url=ssh://git@github.com/derekerdmann/lunch_call.git\n',NULL,NULL,'aa02',NULL,NULL,'0000-00-00 00:00:00'),(180,'#git #mail #add #global',NULL,NULL,'git config --global user.email \"your_email@youremail.com\"',NULL,NULL,NULL,'0000-00-00 00:00:00'),(181,'#git #add #username #name #global',NULL,NULL,'git config --global user.name \"Firstname Lastname\"',NULL,NULL,NULL,'0000-00-00 00:00:00'),(186,'#pentest #methodology#think_about','Definition of Target System(s)\n  the location on the network, types of systems, and business of those systems\n\nTimeframe of the testing\n  \nHow Targets Are Evaluated\n  What types of testing, exploitation are not permitted\n  Examples are; using social networking by pretending to be an employee\n\nTools and software\n\nnotified parties\n  may s1 should be informed about the test\n\nInitial Access Level\n  What type of information and access is provided prior to _kicking off_ the Penetration Test?\n\nDefinition of Target Space\n\nIdentification of Critical Operation Areas\n  which area should not be touched\n\nDeliverable:\n  What type of final report is expected?\n  Remediation expectations:\n\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(187,'#pastebinit #install',NULL,'apt-get install pastebinit',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(188,'#pastebinit #manual',NULL,'\npastebinit file00\nls -a | pastebinit\n  # do not do this next one: \n  # ls -a|pastebinit\n',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(189,'#kali #pentest #sec #intro #basic #concepts #steps #reconnaissance','\nRegardless if the starting point is White, Black, or Gray box testing\n  there is a set of steps that should be followed \n\nReconnaissance\n  learn as much as possible about a target\'s environment\n  The more information you can identify about a target, the better chance you have to identify the easiest and fastest path to success.\n  Black box testing requires more reconnaissance than White box testing\n  can include researching a target\'s Internet footprint,\n\n  The deliverable of a reconnaissance assignment should include a list of all the assets being targeted\n\n  Kali Linux offers a category labeled Information Gathering that serves as a Reconnaissance resource\n  Tools include methods to research network, data center, wireless, and host systems\n\n  The following is the list of Reconnaissance goals:\n•	 Identify target(s)\n•	 Define applications and business use\n•	 Identify system types\n•	 Identify available ports\n•	 Identify running services\n•	 Passively social engineer information\n•	 Document findings\n\n\nTarget evaluation\n  next step is evaluating the target for vulnerabilities.\n\nExploitation\n  the hack\n\nPrivilege escalation\n  think about how to go higher in the hierarchy of the system\n\nMaintaining a foothold\n  think about how I could go back to this hacked_sys at next time\n\n\ndoing the report\n	write a report of your work\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 07:19:06'),(190,'#git #ssh #remote#repo',NULL,NULL,'\ncd ~/.ssh && ssh-keygen\n  to create a pub/private_ssh_key\ncat id_rsa.pub | xclip\n  or copy(ctrl_c) the public key created in ~/.ssh/\ngo in github.com, log_in\ngo to: settings(on right_up of ur profile)\n  ssh_key in the left_middle\n  click add_ssh_key\ncopy the id_rsa.pub \n  add title\n  copy it to key\n','aa01',NULL,NULL,'0000-00-00 00:00:00'),(191,'#mysql #check #version',NULL,NULL,'mysql -h localhost -V\n  -h to determine the host\n  -V to tell that u want the version \n\n\ninside mysql\n	show variable like \'*version*\';\n	select version() ;\n','',NULL,NULL,'0000-00-00 00:00:00'),(192,'#kali #methodology #hack #steps #exo #phase #tool#category','\nreconnaissance\n  information gathering:\n    Tools range from identifying devices to protocols used\n  sniffing_spoofing tools\n\ntarget vulnerabilities\n  Vulnerability Analysis: \n\nexploitation\n  Web Applications\n  password attacks\n  exploitation tools\n\nescalading the hierarchy\n  password attacks\nfootholding\nreport\n\nnot yet done\n',NULL,NULL,NULL,'-p 31 /srv/doc/h/webPenTestWithKali.pdf',NULL,'0000-00-00 00:00:00'),(193,'#irc #connect #server #freenode #irssi',NULL,'/connect irc.freenode.net',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(196,'#conky #intro #monit#sys #linux',NULL,NULL,'surveiller de nombreux paramètres systèmes (charge processeur, occupation mémoire, températures, vitesse ventilateurs, charge batterie, trafic réseau). ',NULL,NULL,NULL,'0000-00-00 00:00:00'),(195,'#linux #bash #test#existance#folder #file #if',NULL,'test -e /path/file00 && echo \'file is there\' || echo \'missing file\'',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(197,'#pentest #sow #methodology','\nBefore you offer Penetration services, write a sow(statement of work)\n  will outlines the work you are going to perform \n',NULL,NULL,NULL,'-p 295 webPenTestWithKali.pdf',NULL,'0000-00-00 00:00:00'),(198,'#dradis #kali #intro #tool','Dradis is an open source framework for information _sharing_.\nDradis provides a centralized repository of information to keep track of:\n  what has been done and\n  still needs to be completed\n\nu can access dradis by running\n  dradis\n  and check at https://127.0.0.1:3004/\n\nfirstime u run dradis,\n  set up a passw for user::root\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 07:20:43'),(199,'default#port',NULL,NULL,'\nfrom: http://web.mit.edu/rhel-doc/4/RH-DOCS/rhel-sg-en-4/ch-ports.html\n\n\nif not mentioned, then it can use udp and tcp \n\ndradis:127.0.0.1:3004\n13 	daytime 	Sends date and time to requesting host \n20 	ftp-data 	FTP data port \n21 	ftp 		File Transfer Protocol (FTP) port; sometimes used by File Service Protocol (FSP) \n22 	ssh 		Secure Shell (SSH) service \n23 	telnet 	The Telnet service\n25 	smtp 	Simple Mail Transfer Protocol (SMTP) \n42 	nameserver 	Internet Name Service \n43 	nicname 	WHOIS directory service \n49 	tacacs 	Terminal Access Controller Access Control System for TCP/IP based authentication and access \n53 	domain 	domain name services (such as BIND) \n63 	whois++ 	WHOIS++, extended WHOIS services \n69 	tftp 	Trivial File Transfer Protocol (TFTP) \n80 	http 	HyperText Transfer Protocol (HTTP) for World Wide Web (WWW) services\n88 	kerberos 	Kerberos network authentication system \n107 	rtelnet 	Remote Telnet \n109 	pop2 	Post Office Protocol version 2\n110 	pop3 	Post Office Protocol version 3 \n115 	sftp 	Secure File Transfer Protocol (SFTP) services \n123 	ntp 	Network Time Protocol (NTP) \n137 	netbios-ns 	NETBIOS Name Service used in Red Hat Enterprise Linux by Samba \n143 	imap 	Internet Message Access Protocol (IMAP)\n161 	snmp 	Simple Network Management Protocol (SNMP) \n174 	mailq 	MAILQ email transport queue \n194 	irc 	Internet Relay Chat (IRC) \n213 	ipx 	Internetwork Packet Exchange (IPX), a datagram protocol commonly used in Novell Netware environments\n220 	imap3 	Internet Message Access Protocol version 3 \n389 	ldap 	Lightweight Directory Access Protocol (LDAP) \n443 	https 	Secure Hypertext Transfer Protocol (HTTP) \n546 	dhcpv6-client 	Dynamic Host Configuration Protocol (DHCP) version 6 client\n547 	dhcpv6-server 	Dynamic Host Configuration Protocol (DHCP) version 6 Service \n565 	whoami 	whoami user ID listing \n631 	ipp 	Internet Printing Protocol (IPP) \n636 	ldaps 	Lightweight Directory Access Protocol over Secure Sockets Layer (LDAPS) \n873 	rsync 	rsync file transfer services \n992 	telnets 	Telnet over Secure Sockets Layer (TelnetS) \n993 	imaps 	Internet Message Access Protocol over Secure Sockets Layer (IMAPS) \n994 	ircs 	Internet Relay Chat over Secure Sockets Layer (IRCS) \n995 	pop3s 	Post Office Protocol version 3 over Secure Sockets Layer (POP3S) \ndradis:127.0.0.1:3004\n3306 	mysql 	MySQL database service \n\n15/tcp 	netstat 	Network Status (netstat) \n\ncheck more at: http://web.mit.edu/rhel-doc/4/RH-DOCS/rhel-sg-en-4/ch-ports.html\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(200,'socket','combination of software Port and IP address',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(201,'#ports #well-known #assigned #default ','Well known ports are from 0 to 1023(total 2^10=1024 ports)\nDefault port is a designated port for particular well-known service such as web server, mail server, ftp server etc. By default FTP uses 21 port, DNS uses 53 and Apache uses 80 port',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(202,'#protocol_number #prot_nb #number','Do not confuse protocol_number with port numbers\n   TCP protocol number:6\n   UDP protocol number:17 \n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(203,'#port #samba','199',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(204,'#port #pop3s','995',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(205,'NFS(nfsd, rpc.nfsd, rpc, portmap)','2049',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(206,'#linux #ls #get#size #awk',NULL,'ls -nlh file00 | awk \'{print $5}\'',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(207,'#casefile #maltegoi #info#gathering','to determine the relationships and real world links between hundreds of different types of information.\ncan be used in information gathering\n',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(208,'#casefile #maltegoi #info#gathering #execution#kali #tool','\ncasefile',NULL,NULL,NULL,NULL,NULL,'2015-01-14 07:20:43'),(209,'#magictree #report #execution#kali #tool',NULL,NULL,'\nMagicTree is a Penetration Tester productivity tool designed for data consolidation, external command execution, and report generation\n',NULL,NULL,NULL,'2015-01-14 07:20:43'),(210,'#mysql #create#user',NULL,NULL,'\nCREATE USER \'max\'@\'localhost\' IDENTIFIED BY \'maxisthebest\';\n  max peut se connecter au_a partir du localhost(l_ordi qui possede mysql)\nCREATE USER \'elodie\'@\'194.28.12.4\' IDENTIFIED BY \'ginko1\';\n  elodie ne peut pas se connecter sur localhost si @localhost diff de 194.28.12.4\nCREATE USER \'gabriel\'@\'arb.brab.net\' IDENTIFIED BY \'chinypower\';\n  a partir d_un @dns\nCREATE USER \'thibault\'@\'194.28.12.%\' IDENTIFIED BY \'basketball8\';\n  peut se connecter sur 194.168.12.2-3-4-....\nCREATE USER \'hannah\'@\'%\' IDENTIFIED BY \'looking4sun\';\n  peut se connecter a partir de _tout_ machine\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(211,'#mysql #rename#user',NULL,NULL,'rename user \'user00\'@\'host00\' to \'user01\'@\'host01\' ;\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(212,'#mysql #change#pass from#root #pwd #password',NULL,NULL,'set password for \'user00\'@\'192.164.1.%\' = password(\'pass00\') ;\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(213,'#mysql #privilege #intro',NULL,NULL,'\nau debut, user00 sans privilege donc peut _rien_(select, insert, ...) faire, se connecte selmnt\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(214,'#mysql #privilege #exemple',NULL,NULL,'\nGRANT SELECT,\n	UPDATE (nom, sexe, commentaires),\n	DELETE,\n	INSERT\nON elevage.Animal\nTO \'john\'@\'localhost\' IDENTIFIED BY \'exemple2012\';\n	action de john sur db(elevage)table(animal): \n		tt selecter\n		updater(nom, sexe, commentaires)\n		tt delete\n		tt insert\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(215,'#mysql #privilege #exemple',NULL,NULL,'\ngrant all on table db00.* to \'user00\'@\'192.168.1.%\' identified by \'pass00\'\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(216,'#mysql #date #now',NULL,NULL,'\nselect curdate() ;\nselect current_date() ;\nselect now() ;\nselect current_date ;\nselect curtime();\n\nselect now();\n  ret datetime\nselect date(now());\nselect time(now());\nselect day(now());\n  1 - 31\nselect dayofweek(now());\n  1 - 7\n  1: sunday\n  2: monday\n  6: friday\n  7: saturday\nselect weekday(now()) ;\n  0 - 6\n  0: sunday\n  1: mon\n  7: sunday\nselect dayname(now());\n  ret sunday | monday | ...\nselect dayofyear(now());\n  ret 1 - 366\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(217,'#mysql #time #lang #langue #language',NULL,NULL,'\nset lc_time_names=\'fr_FR\'\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(218,'#mysql #date #more_options #month',NULL,NULL,'\nselect monthname(now());\nselect year(now());\n\nselect hour(now());\nselect minute(now());\nselect second(now());\n\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(219,'#mysql #date_format #format',NULL,NULL,'\nselect date_format(now(), \'le %W %e %M %Y\') ;\n	le Dimanche 16 Fevrier 2014\n  	%d Jour du mois (nombre à deux chiffres, de 00 à 31)\n	%W Nom du jour de la semaine\n	%a Nom du jour de la semaine en abrégé\n	%m Mois (nombre de deux chiffres, de 00 à 12)\n	%c Mois (nombre de un ou deux chiffres, de 0 à 12)\n	%M Nom du mois\n	%b Nom du mois en abrégé\n	%Y Année, sur quatre chiffres\n	%r Heure complète, format 12h (hh:mm:ss AM/PM)\n	%T Heure complète, format 24h (hh:mm:ss)\n	%H Heure sur deux chiffres et sur 24 heures (de 00 à 23)\n	%i Minutes (de 00 à 59)\n	%e Jour du mois (nombre à un ou deux chiffres, de 0 à 31)\n	%p AM/PM\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(220,'#mysql #str_to_date #get_format',NULL,NULL,'\n\nSELECT STR_TO_DATE(\'11.21.2011\', GET_FORMAT(DATE, \'USA\')) ;\n  11.21.2011 is a date the get_format(date, ...)\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(221,'#mysql #datediff #difference #date',NULL,NULL,'\nSELECT DATEDIFF(\'2011-12-25\',\'2011-11-10\') AS nb_jours;\n  out: 45',NULL,NULL,NULL,'0000-00-00 00:00:00'),(222,'#mysql #timediff #difference #time',NULL,NULL,'\nSELECT TIMEDIFF(\'2011-12-25 21:34:55\',\'2011-11-10 04:54:44\') AS difftime;\n  out: 20:35:20',NULL,NULL,NULL,'0000-00-00 00:00:00'),(223,'#mysql #date #interval',NULL,NULL,'\nselect now() + interval 4 day;\ninsert into table00(col00) values (now() + interval 4 day) ;\n\nselect now() + interval 4 hour;\nselect now() + interval 4 minute;\nselect now() + interval 4 month;\nselect now() + interval 4 year;\n\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(224,'#mysql #show#procedure',NULL,'SHOW PROCEDURE STATUS;',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(225,'#mysql #show#function',NULL,'SHOW FUNCTION STATUS;',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(226,'#mysql #drop#procedure #delete',NULL,NULL,'drop procedure if exists\n  do not forget the \"s\" in \"if exists\"',NULL,NULL,NULL,'0000-00-00 00:00:00'),(227,'#mysql #drop#function #delete',NULL,NULL,'drop function if exists\n  do not forget the \"s\" in \"if exists\"',NULL,NULL,NULL,'0000-00-00 00:00:00'),(228,'#mysql #create#procedure #tip','do not do the creation of a procedure inside \\e of mysql',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(229,'#mysql #inquery #table #notes_tech',NULL,NULL,'select id_n_t, tiitle from notes_tech where tiitle like \'%mysql%\' and tiitle like \'%procedure%\' G',NULL,NULL,NULL,'0000-00-00 00:00:00'),(230,'#mysql #show#db#all',NULL,'show databases;',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(231,'#mysql #show#table#all',NULL,'show tables;',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(232,'#mysql #timestamp #convert to#datetime #from_unixtime',NULL,NULL,'SELECT FROM_UNIXTIME(1325595287)',NULL,NULL,NULL,'0000-00-00 00:00:00'),(233,'#firefox #addons #ads #adblock_edge','Adblock Edge is a fork of the Adblock Plus version 2.1.2 extension for blocking advertisements on the web.',NULL,NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(234,'#mysql #datetime#convert_to#timestamp #from_unixtime #unix_timestamp',NULL,NULL,'SELECT UNIX_TIMESTAMP(\'2012-01-03 13:54:47\');\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(235,'#mysql #convert#time#second #time_to_sec #sec_to_time',NULL,NULL,'select SEC_TO_TIME(102569), TIME_TO_SEC(\'01:00:30\');\n',NULL,NULL,NULL,'0000-00-00 00:00:00'),(236,'#mysql #last #day#month',NULL,NULL,'select last_day(\'2012-02-03\'',NULL,NULL,NULL,'0000-00-00 00:00:00'),(237,'#mysql #show#create#table',NULL,NULL,'show create table table00;\n  that_s show the cmd used to create the table00',NULL,NULL,NULL,'0000-00-00 00:00:00'),(238,'#mysql #create#view',NULL,'create view v_name_view as select * from notes_tech where tiitle like \'%mysql%\'',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(239,'#mysql #create#view #replace',NULL,'create view or replace v_name_view as select * from notes_tech where tiitle like \'%mysql%\'',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(240,'#mysql #drop#view #delete',NULL,'drop view view00',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(241,'#mysql #show#view #list #all',NULL,'SHOW FULL TABLES IN db00 WHERE TABLE_TYPE LIKE \'VIEW\';',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(242,'#mysql #distinct',NULL,'select distinct col00 from table00 ;',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00'),(243,'test',NULL,NULL,NULL,NULL,NULL,NULL,'2015-01-13 07:22:03'),(247,'#mysql #order_of#order_by#limit#offset','already in col::tiitle',NULL,NULL,NULL,NULL,NULL,'2015-01-13 07:36:28'),(248,'#mysql #select #where #like #elargir #extend',NULL,NULL,'\nselect * from table00 where col00 like \'%patt00%\';\n  -- then all lines with col00 in (xxxpatt00xxx) will be selected\n\nselect * from table00 where col00 like \'%patt00%patt01\';\n  -- then all lines with col00 in (xxxpatt00xxxpatt01) will be selected\n\nselect * from table00 where col00 like \'_patt00_\';\n  -- then all lines with col00 in (xpatt00x) will be selected\n  -- only one char\n\nselect * from table00 where col00 like \'_patt00_patt01\';\n  -- then all lines with col00 in (xpatt00Xpatt02) will be selected\n\n',NULL,NULL,NULL,'2015-01-13 07:41:19'),(246,'#mysql #create#procedure #tip',NULL,NULL,'\ndelimiter |\ncreate procedure srch_table_name (in patt varchar(50)) \nbegin \n	set @real_patt=concat(\'%\', patt, \'%\'); \n		-- u shouldn\'t add \'\' inside the real_patt\n		-- this next one is wrong \n		-- set @real_patt=concat(\'\\\'%\', patt, \'%\\\'\');\n	select * from engl where keey like @real_patt ; \nend|\ndelimiter ;\n',NULL,NULL,NULL,'2015-01-13 07:33:44'),(252,'#mysql #select #between #date #and',NULL,NULL,'\nSELECT * FROM table00 WHERE col00 BETWEEN \'2008-01-05\' AND \'2009-03-23\';\n',NULL,NULL,NULL,'2015-01-13 07:53:10'),(250,'#mysql #sensitive#case #casse#sensible #select',NULL,NULL,'\nselect * from table00 where col00 like binary \'%patt00%\';\n',NULL,NULL,NULL,'2015-01-13 07:49:27'),(251,'#mysql #not_like #like #select',NULL,NULL,'\nselect * from table00 where col00 not like \'%patt00%\';\n  it will select all lines _NOT_ containing patt00 in col00\n',NULL,NULL,NULL,'2015-01-13 07:50:18'),(253,'#mysql #count #like #select',NULL,NULL,'\nselect count(id_n_t) from notes_tech where tiitle like \'%patt00%\'\n  it will count all lines which contains patt00\n',NULL,NULL,NULL,'2015-01-13 07:56:27'),(254,'#mysql #select #in',NULL,NULL,'\nselect count(id_n_t) from notes_tech where col00 in (7, 1, 56, 74, 3);\n  it will pick lines with col00=7 1 56 ...\n',NULL,NULL,NULL,'2015-01-13 07:58:13'),(255,'#mysql #dump #mysqldump #save#db',NULL,NULL,'\nmysqldump -u user00 -p --opt base00 > save00.sql # this is a cmd_linux\n  --opt		then the cmd is very fast to exe\n\nUSE nom_base;\nsource file00.sql;\n	# those prev 2 cmd are mysql_cmd, inside: mysql>\n# ifk, u should be in folder00 where file00.sql is in\n',NULL,NULL,NULL,'2015-01-13 08:03:25'),(256,'#mysql #dump #restore#db',NULL,NULL,'\nmysql db00 < file00.sql # this is a cmd_linux\n',NULL,NULL,NULL,'2015-01-13 08:05:39'),(257,'#mysql #conf #order','\nlinux\n	/etc/my.cnf\n	/etc/mysql/my.cnf\n	~/.my.cnf\nwindows\n	WINDIRmy.ini, \n	WINDIRmy.cnf \n		echo %WINDIR% # to check what is WINDIR\n	-\n	C:my.ini ou C:my.cnf \n	-\n	INSTALLDIRmy.ini \n	ou \n	INSTALLDIRmy.cnf \n		INSTALLDIR est le dossier dans lequel MySQL a été installé.\n',NULL,NULL,NULL,NULL,NULL,'2015-01-13 08:37:15'),(258,'#mysql #create#table #insert#default#timestamp #datetime',NULL,NULL,'\ncreate table table00 (\n...\ncol00 timestamp on default current_timestamp on update current_timestamp ;\n...\n',NULL,NULL,NULL,'2015-01-13 09:13:40'),(259,'#mysql #trigger #intro',NULL,NULL,'\nAttachés à une table00\nil y a des instructions qui s\'exe tout seul qud:	\n	faire insert\n	faire update\n	faire delete\nsur table00\n',NULL,NULL,NULL,'2015-01-13 10:19:11'),(260,'#mysql #create#trigger #intro',NULL,NULL,'\ndelimiter |\nCREATE TRIGGER trigger00 \n[ after|before ] \n[ insert|update|delete ]\nON table00 FOR EACH ROW\nbegin\n...\nend |\ndelimiter ;\n\nex:\ndelimiter |\ncreate trigger after_insert_table00 after insert on table00 for each row\nbegin\n...\nend\n|\ndelimiter ;\n',NULL,NULL,NULL,'2015-01-13 10:27:18'),(261,'#mysql #create#trigger #old #new',NULL,NULL,'\nOLD : représente les valeurs des colonnes de la ligne traitée avant qu\'elle ne soit modifiée par l\'événement déclencheur.\nNEW : représente les valeurs des colonnes de la ligne traitée après qu\'elle a été modifiée par l\'événement déclencheur.\n\n',NULL,NULL,NULL,'2015-01-13 11:11:34'),(262,'#exe#linux#cmd_from#mysql',NULL,'mysql> \\! cmd_lin',NULL,NULL,NULL,NULL,'2015-01-13 12:38:45'),(263,'#col',NULL,'val',NULL,NULL,NULL,NULL,'2015-01-13 12:45:03'),(264,'#mysql #show#procedure#definition',NULL,'show create procedure proc00',NULL,NULL,NULL,NULL,'2015-01-13 12:55:10'),(265,'#mysql #warning no#apostrophe #procedure',NULL,NULL,'\ndelimiter |\ncreate procedure ins_nt_t_c(in tiitle00 text, in cmd00 text ) begin insert into notes_tech (tiitle, cmd) values (tiitle00, cmd00); end  \ndelimiter ;\n',NULL,NULL,NULL,'2015-01-13 12:53:50'),(266,'#mysql #sum #select',NULL,NULL,'\nselect sum(col_int) from table00;',NULL,NULL,NULL,'2015-01-13 13:04:08'),(267,'#mysql #index#add #alter',NULL,NULL,'alter table table00 add index (col00)\nalter table table00 add index ind_name(col00)',NULL,NULL,NULL,'2015-01-13 13:11:33'),(268,'#mysql #index#drop #alter',NULL,NULL,'alter table table00 drop index (col00)\nalter table table00 drop index ind_name(col00)',NULL,NULL,NULL,'2015-01-13 13:13:54'),(269,'#mysql #unique #alter',NULL,NULL,'alter table table00 add unique (col00)',NULL,NULL,NULL,'2015-01-13 13:17:04'),(270,'#mysql #fulltext #index #intro #basis #theory','only in tables with engine_myisam\nindex to be applied only in col:varchar, char, text\n\nLorsque vous faites une recherche FULLTEXT sur une chaîne de caractères, cette chaîne est découpée en mots\nmot = toute suite de caractères composée de lettres, chiffres, tirets bas _ et apostrophes\n  porte-clees = 2mots\n\nsi col00 est index(fulltext)\n	table00 doit avoir au moins 3lg\n	faire rech dans col00, alors:\n	  les mots trop courts (moins de quatre lettres) sont ignorés ;\n	  et les mots trop communs (en anglais, about, after, once, under, the...) ne sont également pas pris en compte.\n\nil y a 3 types de _recherche_ pour les col_ind_fulltext:\n	Recherche naturelle\n		un seule coincide, et hop, dans resultat\n		#mysql #fulltext #index #select #match#against #in#natural#language#mode\n	Recherche avec booléens\n		not yet done\n	Recherche avec extension de requête\n\nnot yet done\n',NULL,NULL,NULL,'-p 80 464494-administrez-vos-bases-de-donnees-avec-mysql.pdf',NULL,'2015-01-13 13:58:26'),(271,'#mysql #alter#table #change#engine',NULL,NULL,'alter table table00 engine = myisam',NULL,NULL,NULL,'2015-01-13 15:20:39'),(272,'#mysql #query #replace_in#string',NULL,NULL,'UPDATE table00 SET col00 = REPLACE (col00, \'SearchForThis\', \'ReplaceWithThis\') where id_col > 1',NULL,NULL,NULL,'2015-01-13 15:25:18'),(273,'#mysql #show#index #list #all',NULL,NULL,'show index from table00;',NULL,NULL,NULL,'2015-01-13 15:27:33'),(274,'#mysql #check#status',NULL,NULL,'mysql> status',NULL,NULL,NULL,'2015-01-13 15:30:13'),(275,'#mysql #create#table #fk #foreign#key #jointure',NULL,NULL,'\nto make in relation table00 and table01\n\ncreate table table00(\n...\nconstraint foreign key(col_in_table00) references table01(col_in_table01)\n...\n);\n #relation',NULL,NULL,NULL,'2015-01-13 17:24:42'),(276,'#mysql #select #jointure #relation',NULL,NULL,'\nrelation:\n	table00(col00) to table01(col00)\n\nselect * from table00 inner join table01 on table00.col00=table01.col00 where table00.col00a=34;\n',NULL,NULL,NULL,'2015-01-13 17:31:59'),(277,'#mysql #select #jointure #interne#externe #basic #theory',NULL,NULL,'\nSELECT * FROM A INNER JOIN B ON A.a = B.b\nCeci retournera uniquement les lignes pour lesquelles A.a et B.b correspondent.\n\nexterne, comme interne mais:\n  	permet de sélectionner également les lignes pour lesquelles il n\'y a pas de correspondance dans une des tables jointes\n	deux types de jointures externes \n		jointures par la gauche \n			par: LEFT JOIN ou LEFT OUTER JOIN\n			on veut toutes les lignes de la table de gauche \n				même si certaines n\'ont pas de correspondance avec une ligne de la table de droite\n\n		jointures par la droite \n\n	evince -p 104 464494-administrez-vos-bases-de-donnees-avec-mysql.pdf\n',NULL,NULL,NULL,'2015-01-13 19:24:59'),(278,'#vimperator #basic #tab #next#prev',NULL,NULL,'gt: got to next\ngT: go to prev tab',NULL,NULL,NULL,'2015-01-14 06:11:04'),(279,'#vimperator #basic #history #next#prev',NULL,NULL,'<C-o>: go back in the history of the curr_tab\n<C-i>: go forward in the history of the current_tab',NULL,NULL,NULL,'2015-01-14 06:15:15'),(282,'#vimperator #basic #open#url in #other_tab',NULL,NULL,':tabopen url.com\nOR\nturl.com',NULL,NULL,NULL,'2015-01-14 06:17:36'),(281,'#vimperator #basic #open#url in #current_tab',NULL,NULL,':open url.com\nOR\nourl.com',NULL,NULL,NULL,'2015-01-14 06:16:55'),(283,'#webcam #block',NULL,NULL,'modprobe -r uvcvideo',NULL,NULL,NULL,'2015-01-14 08:22:44'),(284,'#webcam #block',NULL,NULL,'\nedit:/etc/modprobe.d/blacklist.conf\nadd:\n  blacklist uvcvideo\n\nhttp://askubuntu.com/questions/166809/how-can-i-disable-my-webcam\nhttps://answers.yahoo.com/question/index?qid=20120727182612AAfYgGs',NULL,NULL,NULL,'2015-01-14 08:23:58'),(285,'#linux #add#remove#module #modprobe #charge#decharge',NULL,NULL,'\nmodprobe -a mod00\n  to add it\nmodprobe -r mod00\n  to rm it\n\nto rm it permanently\n  vi /etc/modprobe.d/blacklist.conf\n  add:\n    blacklist uvcvideo\n',NULL,NULL,NULL,'2015-01-14 10:18:38'),(286,'#kali #waybackmachine #methodology #robot #site#info#gathering','\nsite00.com/robots.txt\n  will show what are disallowed for visiting\n\nto get how looked like the site00.com many years before:\nto see the evolution of the site00.com\n	got at \n		www.archive.org\n		https://web.archive.org/web/*/http://www.site00.com\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 10:54:58'),(287,'#tuto #info#gathering #byme','\ntake a website: site00.com\n	ping www.site00.com\n		to get the ip00 of site00.com\n	whois ip00\n		to get many info about site00.com\n #warning: this next one is to not do:\n  whois www.site00.com',NULL,NULL,NULL,NULL,NULL,'2015-01-14 11:43:47'),(288,'#myip',' 41.204.110.74',NULL,NULL,NULL,NULL,NULL,'2015-01-14 11:45:20'),(289,'#myip by#arin.net',' 41.204.110.74',NULL,NULL,NULL,NULL,NULL,'2015-01-14 11:46:34'),(290,'#tool #sec #payant #linux #kali #pentest #nessus not#free','\nnessus est un outil de sécurité informatique.\n	signale les faiblesses potentielles ou avérées du matériel testé (machines, équipement réseau).\n	capable de scanner un équipement (machine ou matériel réseau), un ensemble d\'équipements (à partir d\'un fichier ou d\'une plage IP) ou encore un réseau entier.\n 	Le résultat du scan fournira :\n 		la liste des vulnérabilités par niveaux de criticité,\n		une description des vulnérabilités,\n		et surtout la méthode ou un lien pour solutionner le problème.\n	\n	  	/srv/mmedia/pic/Nessus-Google-Chrome_2012-03-20_19-01-57.png \n    (http://www.nessus.org/download/). ',NULL,NULL,NULL,NULL,NULL,'2015-01-14 12:11:22'),(291,'#tool #kali #pentest #maltego','Maltego can comb popular social media, public records, and job recruiting websites to fingerprint an individual based on limited information\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 12:21:21'),(292,'#tool #kali #pentest #maltego #methodology','Maltego can comb popular social media, public records, and job recruiting websites to fingerprint an individual based on limited information\n  A researcher could gather information such as everywhere an individual has lived,\n	one business, people with which they socialize, special interests, favorite sport\nteams, and other useful data for future research and social engineering attack',NULL,NULL,NULL,NULL,NULL,'2015-01-14 12:23:41'),(293,'#beef #tool #kali #intro #pentest','\nBeEF is a browser-based exploit package that \"hooks\" one or more\n	browsers as beachheads for launching attacks. A user can be hooked by accessing a\n	customized URL and continue to see typical web traffic, while an attacker has access\n	to the user\'s session.\n\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 12:51:37'),(294,'#beef #tool #kali #intro #pentest','ifk: beef is useful while pentester has access to the user_s session',NULL,NULL,NULL,NULL,NULL,'2015-01-14 12:52:06'),(295,'#beef #tool #kali #intro #pentest','BeEF bypasses network security appliances and host–based, anti-virus applications by targeting the vulnerabilities found in common browsers, such as ff and ie',NULL,NULL,NULL,NULL,NULL,'2015-01-14 12:53:56'),(296,'#kali #tool #beef #run#server #tuto','\ncd /usr/share/beef-xss\n./beef\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 13:28:54'),(297,'#kali #tool #beef #methodology','\nu need to redirect the victim into ur beef_url_hook(in_running_server: http://127.0.0.1:3000/hook.js) \n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 13:07:08'),(299,'#kali #tool #panel #admin#beef #run #tuto','\nafter running the server of beef, \nu need to go in interface_ui|web_admin of beef:\n	go at: http://127.0.0.1:3000/ui/panel\n		which u see in the terminal of running of beef_server\n	\n	in the first time of connection to server_beef:\n		username: beef\n		password: beef\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 13:21:51'),(300,'#burp #kali #methodology #tool','\nBurp Proxy is a tool that intercepts HTTP and HTTPS traffic. It allows a Penetration\nTester to examine an application, its vulnerabilities, and the two-way traffic between\na client and a web server. Burp Proxy is very popular because of its ability to not\nonly examine the traffic, but also, it manipulates requests\n\nWhen a user enters a URL in their web browser such as http://www.DrChaos.com, \nthey expect to be directed to the website. A proxy server will\nintercept that request and send it on behalf of a client\n\n',NULL,NULL,NULL,NULL,NULL,'2015-01-14 14:04:42');
...
-- Dump completed on 2015-01-14 16:18:39
