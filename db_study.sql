...
INSERT INTO `engl` VALUES (1,'#for_#without',NULL,'\nfor without Andy, I couldn\'t study at ispm\n',NULL,NULL,NULL),(2,'#afoot','beeing planned or happening','there were plans afoot for a second attack\n\n',NULL,NULL,NULL),(3,'#dislodge','to force s1 to leave a position or a place\nOR\nto force or to knock sth out of a place where it was held','army commanders were planned to dislodge the president',NULL,NULL,NULL),(4,'#whisper','to say sth very quietly','she whispered some words to my ear\nit is whispered that Aslan was a hacker\n  ifk: then this is a kinda rumour\n','v',NULL,NULL),(5,'to fiddle','to keep touching sth bcz u_re bored','laura fiddled with her cup\nand i kept on fiddling with BTR2','v','to fidget, to twiddle, to fuss, to mess around',NULL),(6,'winging','to start travelling on wings or by aircraft','a bird came winging around the corner','noun',NULL,NULL),(7,'to idle','To move slowly or without purpose',' Idling is welcome as we rebuild!','v',NULL,NULL),(8,'either way','The one or the other way','\nSometimes your system might crash or a power failure might take the machine down. Either way, at the next boot, a lengthy filesystem check using fsck will be done',NULL,NULL,NULL),(9,'brag','To talk or write about oneself in a proud or self-impressed way',NULL,'v','to boast',NULL),(10,'somewhat','some part or amount; something.','somewhat clearer::mazavazava kely',NULL,NULL,NULL),(11,'behalf',NULL,' in or on someone\'s behalf:: in someone\'s interests',NULL,NULL,NULL),(12,'due','ifk: syn of worthwhile','this bill is due',NULL,NULL,NULL),(13,'digital #assets','asset has many senses','digital assets::(digital ressources)',NULL,NULL,NULL),(14,'to fire up','to start','the attackerbegins by firing up the latest version of Metasploit',NULL,NULL,NULL),(15,'a soft spot','somewhat weakness','After exploring the target’s perimeter, he finds a soft spot',NULL,NULL,NULL),(16,'impact',NULL,'you’ve shown true business impact,\n  u found the pillar of the business',NULL,NULL,NULL),(17,'oddly enough',NULL,'Oddly enough\n  transitive which means sth strange happened\n  ifk_ex : she played hard to get. oddly enough, she was pregnant :/ ',NULL,NULL,NULL),(18,'compromise','a kinda rule which is set to solve some issues\n  ex : the 2presidents set a compromise',NULL,'noun',NULL,NULL),(19,'compromise','hacked, found the a soft spot, then that will be exploited',NULL,'verb',NULL,NULL),(20,'fictitious',NULL,'\npenetration testers often find themselves in the role of a fictitious adversary',NULL,NULL,NULL),(21,'chink',NULL,'identify chinks in the armor, \n  ifk: to find the error in the armor',NULL,NULL,NULL),(22,'breach',NULL,'\nand prevent serious data breaches.\n  to prevent that data will be hacked',NULL,NULL,NULL),(23,'circumvent',NULL,'By attempting to circumvent security\n  to attempt to escape the sec',NULL,NULL,NULL),(24,'overnight',NULL,'\nAnd you won’t become an expert penetration tester overnight\n  u will not be a pentester very soon',NULL,NULL,NULL),(25,'proficient',NULL,'\nit takes years of practice and real-world experience to become proficient.\n  it takes years of practice to be good at it(sth mentionned before) ',NULL,NULL,NULL),(26,'currently, shift',NULL,'\nCurrently, there is a shift in the way people define penetration testing \n  now, many people has its way to define pentest',NULL,NULL,NULL),(27,'overwhelmed',NULL,' i_m overwhelmed of her way of speaking\n   i_m so fascinated .... ',NULL,NULL,NULL),(28,'charter',NULL,'the Yalta charter',NULL,NULL,NULL),(29,'scope',NULL,'u should define the scope of the pentest\n  u should define how far u_r pentest_action should go',NULL,NULL,NULL),(30,'convey',NULL,'\nu convey the goals of the engagement\n  u define the goal of the engagement',NULL,NULL,NULL),(31,'thorough',NULL,'what is to be expected from a thorough \n  what is expected to be done completely',NULL,NULL,NULL),(32,'probe',NULL,'by slowly starting to probe its systems\n  then u start to go in, slowly for getting some information',NULL,NULL,NULL),(33,'insight',NULL,'sommaire gives u an _insight_ of what are inside the book',NULL,NULL,NULL),(35,'insight',NULL,'sommaire gives u an _insight_ of what are inside the book\n   like set but which is contained in a set',NULL,NULL,NULL),(36,'threshold',NULL,'\nafter a certain threshold, the web application firewalls will block you from making further requests.\n  bcz u went beyond a limit then u_re blocked from making further requests\n',NULL,NULL,NULL),(37,'to take into account',NULL,'\nvulnerability analysis takes into account port and vulnerability scans\n',NULL,NULL,NULL),(38,'banner grabbing',NULL,'\nthere was a banner which was set and that is not to compromise',NULL,NULL,NULL),(39,'glamourous',NULL,'\nfascinating and exciting',NULL,NULL,NULL),(40,'unforeseen','\nu didn_t expect','an unforeseen trip is a trip which u didn_t expect to happen',NULL,NULL,NULL),(41,'onslaught','attack','Blindly firing off a mass onslaught of exploits isn_t productive',NULL,NULL,NULL),(42,'to fire off','to decide to attack','Blindly firing off a mass onslaught of exploits isn\'t productive',NULL,NULL,NULL),(43,'run-of-the-mill','like the others in his type, very standard, very common',NULL,NULL,NULL,NULL),(44,'wits','almost the same as the soul','\nrely on your wits\n  ifk: to trust in ur soul',NULL,NULL,NULL),(45,'to rely on','almost like to trust','\nrely on your wits\n  ifk: to trust in ur soul|brain',NULL,NULL,NULL),(46,'plethora','A large or excessive amount of something','kali comes with a plethora of penetration testing tools',NULL,NULL,NULL),(47,'to lie','rest flat on a surface','use cli in linux bcz that’s where the real power lies',NULL,NULL,NULL),(48,'versatile','flexible','nc is a versatile tool in for tcp-ip connection\n  then nc is is not rigid, and useful in tcp-ip connection ',NULL,NULL,NULL),(49,'to issue','to deliver|exe a commandment','\nyou can see the programs listening on TCP ports by _issuing_ the command netstat -antp,\n',NULL,NULL,NULL),(50,'indeed','exactly','\n(after some remarks on result of some cmd)\n  As you can see, Netcat reports that port 80 is indeed listening\n',NULL,NULL,NULL),(51,'subsequent','fr(ulterieur)','\nin subsequent chapter\n',NULL,NULL,NULL),(52,'exploit #ptes','a _code_ which allows an tester to take advantage of the vulnerable sys\nevery vulnerability has its own corresponding exploit\n',NULL,NULL,NULL,NULL),(53,'payload #ptes','code which runs on the sys after exploitation',NULL,NULL,NULL,NULL),(54,'to leverage','The power to influence a person or situation','msfconsole is leveraging all the functionalities of metasploit',NULL,NULL,NULL),(55,'solely','Not involving anyone or anything else; only','\nIt is simply not true that smoking is solely responsible for the current cancer epidemic\n\nu have not to rely solely on what u got from school',NULL,NULL,NULL),(56,'reside','Have one’s permanent home in a particular place','\n people who work in the city actually reside in neighbouring towns',NULL,'live in, occupy, inhabit, have one\'s home in, be settled in, have taken up residence in, have establ',NULL),(57,'stealth',' Cautious(ifk:carefulness) and surreptitious action or movement','\n the silence and stealth of a hungry cat',NULL,NULL,NULL),(58,'greedy','Having an excessive desire or appetite for food','greedy society, fuelled by educational expectation and privilege.',NULL,NULL,NULL),(59,'assess','Evaluate or estimate the nature, ability, or quality of sth','A child\'s development is evaluated by assessing the child\'s abilities on a range of tasks and behaviours',NULL,NULL,NULL),(60,'assessment','The action of assessing someone or something','Kali is a Penetration Testing arsenal to perform security assessments\n',NULL,NULL,NULL),(61,'audit - overlap','A systematic review or assessment of something\nCover part of the same area of interest, responsibility, etc','Many organizations offer security services and use terms such as security audit, network or risk assessment, and Penetration Test with overlapping meanings\n\n**meaning ifk\nsec service, sec audit, net assessment, risk assessment, pen test, are in the same boat\n',NULL,NULL,NULL),(62,'feature to_season','A distinctive attribute or aspect of something making a significant contribution\nAdd salt, herbs, pepper, or other spices to (food)','this book is for user who are new to Kali Linux and want to learn the features and differences in Kali versus BackTrack, and seasoned Penetration Testers who may need a refresher or reference on new tools and techniques \n',NULL,'add flavouring to\n pep up\nadd zing to',NULL),(63,'within','fr:certain','Web applications are the most widely used type of applications within any organization\n  web application are the most used type of app in many organization',NULL,NULL,NULL),(64,'scope','A purpose, end, or intention','Penetration Testing web applications can vary in scope\nAn example for developing a scope for a web application Penetration Test is testing a Linux server hosting applications for mobile devices.\nThe scope of work at a minimum should include evaluating the Linux server\n',NULL,NULL,NULL),(65,'to scope','to look at carefully - to scan','We have included templates for scoping a web application penetration\n',NULL,NULL,NULL),(66,'to assist','[no object] Be present as a helper','Some deliverable examples in this chapter offer checkbox surveys that can assist \n\ntwo midwives who assisted at a water birth',NULL,NULL,NULL),(67,'to customize - timeframe','to modify sth to suit a particular task\n\nA specified period of time in which something occurs or is planned to take place','Every scope of work should be customized around your customer\'s business objectives, expected timeframe of performance',NULL,NULL,NULL),(68,'to allocate','Distribute (resources or duties) for a particular purpose','an allocated funds',NULL,NULL,NULL),(69,'outcome','a consequence, The way a thing turns out','ifk: what is the desired outcome of this program',NULL,NULL,NULL),(70,'boundary','A line which marks the limits of an area; a dividing line\nA limit of something abstract,','Real attackers do not have boundaries such as time, funding, ethics, or tools meaning',NULL,NULL,NULL),(71,'credential','A document proving a person’s identity or qualifications','For example, a Penetration Tester may capture user credentials to critical systems',NULL,NULL,NULL),(72,'to hang: hung',NULL,'when u finished ur phone call, u hung_up the phone\na server may hung up unexpectedly\n',NULL,NULL,NULL),(73,'controversial',NULL,NULL,NULL,'disputable, debatable, arguable, moot, at issue, contentious',NULL),(74,'to disclose - to give away','to reveal - to divulge','Many security professionals believe if they disclose their tools they will be giving away their secret sauce\n',NULL,'to reveal',NULL),(75,'beforehand','in advance','Are they briefed beforehand and able to prepare?\n',NULL,NULL,NULL),(76,'to kick off','to start, to get going, to get off the ground','What type of information and access is provided prior to kicking off the Penetration Test?\n',NULL,NULL,NULL),(77,'to grant','allow, accord, permit, afford, concede, vouchsafe','What type of initial account\nlevel access is granted? Is this a Black, White, or Gray box assignment foreach target?\n',NULL,NULL,NULL),(78,'pooter','sth makes sound like farting',NULL,NULL,NULL,NULL),(79,'to get',NULL,'\nupdating your profile with your name, location, and a profile picture helps other GitHub users get to know you',NULL,NULL,NULL),(80,'baseline','A line serving as a basis, as for measurement, calculation, or location','Standards and baselines achieve consistency in security\n',NULL,NULL,NULL),(81,'consistent','Acting or done in the same way over time, especially so as to be fair or accurate','Standards and baselines achieve consistency in security\n',NULL,NULL,NULL),(82,'outweigh','Be heavier, greater, or more significant than','\nIt is up to the customer to decide if the risk associated to vulnerability found justifies\nor outweighs the cost of controls required to reduce the risk to an acceptable level\n',NULL,NULL,NULL),(84,'aficionados - dork','A person who is very knowledgeable and enthusiastic about an activity, subject, or pastime\ndefinition of dork is set in the ex','\nThe aficionados who have categorized the Google searches are affectingly known as Google dorks\n  dork is a contemptible, socially inept person\n  dork is a man_s penis in the north of america\n',NULL,NULL,NULL),(85,'hood - hoody','A covering for the head and neck with an opening for the face\nhoodies are the cloth with hood','u can buy shirt and hoodies from hackersforcharity.org',NULL,NULL,NULL),(86,'snide','mocking in an indirect way','\nYou’ll be amazed at the dirty looks and snide comments you’ll get when you wear this shirt from hackersforcharity.org',NULL,NULL,NULL),(87,'straight',NULL,'You’ll get a chance to set people straight when u wear shirt from hfc\ngo straight, u_ll see the house after 100meters',NULL,NULL,NULL),(88,'foothold','A place where a person’s foot can be lodged to support them securely, especially while climbing','Twice she had to stop to rest, her arms trembling with the strain, locking her feet into semi-secure footholds and leaning into the rock.',NULL,NULL,NULL),(89,'footprint','The impression left by a foot or shoe on the ground or a surface',NULL,NULL,NULL,NULL),(90,'incentive - to line up','A thing that motivates or encourages someone to do something\n\nArrange a number of people or things in a straight row','\nyou may even qualify for some wicked incentives we’re lining up:\n  conference passes, free training courses and much more.\n',NULL,NULL,NULL),(91,'deceit - conceal',' The action or practice of deceiving someone by concealing or misrepresenting the truth\n  to conceal sth is to hide it','\nduring times of universal deceit, telling the truth becomes a revolutionary act... george orwell\n',NULL,NULL,NULL),(92,'takeaway','A key fact, point, or idea to be remembered, typically one emerging from a discussion or meeting',NULL,NULL,NULL,NULL),(93,'upfront','in the front','Providing the potential toolset upfront also reduces the likelihood of the customer having a negative reaction when a negative impact occurs due to the use of a tool.',NULL,NULL,NULL),(94,'an issue - to issue','An important topic or problem for debate\nPersonal problems or difficultie\n\ndistribute (something) for use or sale','the issue of racism\nwith an account you are issued an individual workspace to use\n',NULL,NULL,NULL),(95,'stakeholder','A person with an interest in sth, especially in business','writing sow is typically the first step you would want to complete with your _stakeholders_ before starting a project\n',NULL,NULL,NULL),(96,'dock','An enclosed area of water in a port for the loading, unloading, and repair of ships','A port is piece of software which is used as docking point in your machine, where remote application can communicate. This is analogy to the physical ports for entering in to a country from different sea ports.',NULL,NULL,NULL),(97,'socket','combination of software Port and IP address',NULL,NULL,NULL,NULL),(98,'to consolidate','to bring together (separate parts) into a single or unified','They consolidated their three companies,\n\nMagicTree is a Penetration Tester productivity tool designed for data consolidation',NULL,NULL,NULL),(99,'to trip up','Make a mistake','so you can check to see the next table if any of the same mistakes have been tripping you up',NULL,NULL,NULL),(100,'sufficient','Enough; adequate','In the past, these common defenses were sufficient; however, threats are becoming more sophisticated nowadays',NULL,NULL,NULL),(101,'mundane','Lacking interest or excitement; dull',NULL,NULL,NULL,NULL),(102,'to bond - means','Join or be joined securely to something else, especially by means of an adhesive substance, heat, or pressure',NULL,NULL,NULL,NULL),(103,'to embed','Fix (an object) firmly and deeply in a surrounding mass','he had an operation to remove a bullet embedded in his chest',NULL,NULL,NULL),(104,'rear - decent','The back part of something, especially a building or vehicle\nConforming with generally accepted standards of respectable ','< lewellyn> embedding lua is a pain in the _rear_ :D\n< mniip > I haven\'t had any rear pains when embedding lua\n< lewellyn> you\'re not doing complex enough things then :D\n< mniip> maybe not\n< dx> i\'d still consider lua a decent option for embedding ',NULL,NULL,NULL),(105,'to strive','Make great efforts to achieve or obtain something',NULL,NULL,NULL,NULL),(106,'#suffix ener',NULL,'shortener \nfastener',NULL,NULL,NULL),(107,'perform',' accomplish, or fulfil or carry out(an action, task, or function)',NULL,NULL,NULL,NULL),(108,'to overcome #a7x#fiction','Succeed in dealing with (a problem or difficulty)\n(Of a feeling or emotion) overpower or overwhelm','now i think i understand, hos the world can overcome a men, # the second definition',NULL,NULL,NULL),(109,'to see through #a7x#fiction',NULL,'like a friend we saw it through, in the end i give my life 4 u\n  ifk: like a friend we saw it, .... ',NULL,NULL,NULL),(110,'#to#think#about #thinkabout #to#give #a7x#fiction','gave u all i had to give',NULL,NULL,NULL,NULL),(111,'#thinkabout #out #a7x#fiction','hope it_s worth it _out_ on the highway',NULL,NULL,NULL,NULL),(112,'#thinkabout #beside #one #a7x #fiction','so tell everybody, the one_s who walked beside me',NULL,NULL,NULL,NULL),(113,'seize','ifk: hold sth suddenly and with force\nreal:take hold of suddenly and forcibly','seize the day or die regretting the time you lost',NULL,NULL,NULL),(114,'#thinkabout #seize','seize the day or die regretting the time you lost',NULL,NULL,NULL,NULL),(115,'to ache','A continuous or prolonged dull pain in a part of one’s body','the ache in her head worsened',NULL,NULL,NULL),(116,'#thinkabout #ache#out #a7x#seize_the_day','seize the day or die regretting the time you lost, it_s empty and cold without u here, too many people to ache over',NULL,NULL,NULL,NULL),(117,'#undergo #a7x#seize_the_day #arduous','to experience sth hard, painful, arduous',' the baby underwent a life-saving brain operation',NULL,NULL,NULL),(118,'#thinkabout #undergo #will #a7x#seize_the_day','these_s streets we traveled on will undergo our same lost past ',NULL,NULL,NULL,NULL),(119,'to hand','Pick (something) up and give to (someone)','i hand u my immortal life ',NULL,NULL,NULL),(120,'trowel',NULL,NULL,NULL,NULL,'eog/srv/mmedia/pic/trowel00.jpg'),(121,'#thinkabout #interrogation #will #a7x#seiwe_the_da','i hand u my mortal life, but will it be 4vr?',NULL,NULL,NULL,NULL),(122,'fable','A short story, typically with animals as characters,',NULL,NULL,NULL,NULL),(123,'journey','An act of traveling from one place to another','will you take a journey tonight',NULL,NULL,NULL);
...
-- Dump completed on 2015-01-13 16:57:48
